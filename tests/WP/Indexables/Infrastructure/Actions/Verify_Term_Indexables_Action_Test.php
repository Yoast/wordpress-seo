...
/**
 * Integration Test Class for Verify_Term_Indexables_Action.
 *
 * @coversDefaultClass Yoast\WP\SEO\Indexables\Infrastructure\Actions\Verify_Term_Indexables_Action
 */
final class Verify_Term_Indexables_Action_Test extends TestCase {
	...
	public function setUp(): void {
		parent::setUp();
		global $wpdb;
		$this->instance = new Verify_Term_Indexables_Action(
