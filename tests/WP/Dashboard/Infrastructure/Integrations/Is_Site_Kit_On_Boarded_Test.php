...
final class Is_Site_Kit_On_Boarded_Test extends TestCase {
	...
	public function set_up() {
		...
		$site_kit_feature_conditional      = new Google_Site_Kit_Feature_Conditional( new Options_Helper() );
		$site_kit_conditional              = new Site_Kit_Conditional();
		$this->instance                    = new Site_Kit( $this->site_kit_consent_repository, $configuration_repository, $site_kit_is_connected_call, $site_kit_feature_conditional, $site_kit_conditional );
	}
