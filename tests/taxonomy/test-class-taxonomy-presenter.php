...
class WPSEO_Taxonomy_Presenter_Test extends WPSEO_UnitTestCase {
	...
	public function test_display_fields() {
		...
		$expected = '<label for="wpseo_fieldname">test field</label><input name="wpseo_fieldname" id="wpseo_fieldname"  type="text" value="" size="40" aria-describedby="wpseo_fieldname-desc"/><p id="wpseo_fieldname-desc">this is a test field</p>';
	...
	public function test_display_fields_no_label() {
		...
		$expected = '<input name="wpseo_fieldname" id="wpseo_fieldname"  type="text" value="" size="40" aria-describedby="wpseo_fieldname-desc"/><p id="wpseo_fieldname-desc">this is a test field</p>';
		$expected = sprintf( $expected, plugins_url( 'images/question-mark.png', WPSEO_FILE ) );
