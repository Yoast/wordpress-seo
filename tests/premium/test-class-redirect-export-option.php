...
class WPSEO_Redirect_Export_Option_Test extends WPSEO_UnitTestCase {
	...
	/**
	 * @var WPSEO_Redirect_Export_Option
	 */
	...
	public function setUp() {
		$this->class_instance = new WPSEO_Redirect_Export_Option();
	}
	 ...
	 *
	 * @covers WPSEO_Redirect_Export_Option::export
	 */
	 ...
	 *
	 * @covers WPSEO_Redirect_Export_Option::format
	 */
