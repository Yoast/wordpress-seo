...
class WPSEO_Export_Keywords_Term_Query_Test extends WPSEO_UnitTestCase {
	...
	public static function setUpBeforeClass() {
		...
		require_once WPSEO_TESTS_PATH . 'premium/doubles/export-keywords-term-query-double.php';
		require_once WPSEO_TESTS_PATH . 'premium/doubles/export-keywords-term-query-database-mock.php';
	}
