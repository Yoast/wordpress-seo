...
class WPSEO_Premium_Prominent_Words_Support_Test extends WPSEO_UnitTestCase {
	...
	public function setUp() {
		...
		$this->class_instance = new WPSEO_Premium_Prominent_Words_Support();
	}
	...
	public function test_get_supported_post_types_with_hook() {
		...
		remove_filter( 'wpseo_prominent_words_post_types', array( 'WPSEO_Post_Type', 'filter_attachment_post_type' ) );
	}
	...
	public function test_get_supported_post_types_with_hook_that_returns_bool() {
		add_filter( 'wpseo_prominent_words_post_types', '__return_false' );
		...
		remove_filter( 'wpseo_prominent_words_post_types', '__return_false' );
	}

	/**
	 * Tests the default situation where the attachment post type is supported.
	 *
	 * @covers WPSEO_Premium_Prominent_Words_Support::is_post_type_supported()
	 */
