...
class WPSEO_Premium_Free_Translations_Test extends WPSEO_UnitTestCase {
	/**
	 * Tests wether the HTTP request args filter provides the expected results.
	 *
	 * This functionality test if the Yoast SEO plugin is added to the upgrade request to WordPress.org
