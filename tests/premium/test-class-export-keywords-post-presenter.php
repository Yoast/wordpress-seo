...
class WPSEO_Export_Keywords_Post_Presenter_Test extends WPSEO_UnitTestCase {
	...
	public static function setUpBeforeClass() {
		...
		require_once WPSEO_TESTS_PATH . 'premium/helpers/class-export-keywords-post-presenter-double.php';
		require_once WPSEO_TESTS_PATH . 'premium/helpers/class-export-keywords-post-presenter-test-filter.php';
	}
