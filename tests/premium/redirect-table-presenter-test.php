...
class WPSEO_Redirect_Table_Presenter_Test extends WPSEO_UnitTestCase {
	...
	public function test_display_regex() {
		...
		$class_instance->set_table( array() );
		...
		$this->assertContains( 'Regular Expression (regex) Redirects are extremely powerful redirects. You should only use them if you know what you are doing.', $output );
