...
/**
 * Test class for testing WPSEO_Redirect_File_Apache
 *
 * Class WPSEO_Redirect_File_Apache_Test
 */
class WPSEO_Redirect_File_Apache_Test extends WPSEO_UnitTestCase {
	...
	public function setUp() {
		$this->class_instance = $this->getMock( 'WPSEO_Redirect_File_Apache', array( 'generate_content' ) );
	}

	/**
	 * Testing if the saving method will be called and returns true
	 *
	 * @covers WPSEO_Redirect_File_Apache::save
	 */
