...
class Abstract_Indexable_Tag_Presenter_Test extends TestCase {
	...
	public function test_key_not_defined() {
		...
		$this->expectExceptionMessage( 'Yoast\WP\SEO\Tests\Unit\Presenters\Concrete_Indexable_Presenter is an Abstract_Indexable_Tag_Presenter but does not override the key property.' );
