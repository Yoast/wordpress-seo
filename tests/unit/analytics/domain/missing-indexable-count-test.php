 ...
 * @group  analytics
 *
 * @coversDefaultClass \Yoast\WP\SEO\Analytics\Domain\Missing_Indexable_Count_Test
 * @covers \Yoast\WP\SEO\Analytics\Domain\Missing_Indexable_Count_Test
 */
class Missing_Indexable_Count_Test extends TestCase {
	 ...
	 * The sut.
	 *
	 * @var \Yoast\WP\SEO\Analytics\Domain\Missing_Indexable_Count
	 */
	private $sut;
