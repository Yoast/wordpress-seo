	...
	public function test_enqueue_import_script() {
		...
		$injected_data = [
			...
			'assets'  => [
				...
				'import_failure' => '<div class="yoast-measure yoast-import-failure"><div class="yoast-alert yoast-alert--error"><span><img class="yoast-alert__icon" src="https://example.org/wp-content/plugins/images/alert-error-icon.svg" alt="" /></span><span>Import failed with the following error:<br/><br/>%s</span></div></div>',
