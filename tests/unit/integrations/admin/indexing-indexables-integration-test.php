 ...
 *
 * @coversDefaultClass \Yoast\WP\SEO\Integrations\Admin\Indexing_Links_Integration
 *
 * @group integrations
 * @group indexing
 */
class Indexing_Indexables_Integration_Test extends TestCase {
	...
	protected function setUp()  {
		...
		$this->instance = new Indexing_Links_Integration(
	...
	public function test_get_conditionals() {
		static::assertEquals(
			...
			Indexing_Links_Integration::get_conditionals()
		);
	}
