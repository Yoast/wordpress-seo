...
class Aioseo_Default_Archive_Settings_Importing_Action_Test extends TestCase {
	...
	protected function set_up() {
		...
		$this->instance           = new Aioseo_Default_Archive_Settings_Importing_Action( $this->options, $this->utils, $this->replacevar_handler, $this->robots_provider, $this->robots_transformer );
