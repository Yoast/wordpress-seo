...
/**
 * Class Test_Yoast_API_Libs_Required_Version_Notifier
 */
class Test_Yoast_API_Libs_Required_Version_Notifier extends WPSEO_UnitTestCase {

	/**
	 * Get notification should return a Yoast_Notification
	 */
	public function test_get_notification_return_value() {
		$subject = new Yoast_API_Libs_Required_Version_Notifier();
