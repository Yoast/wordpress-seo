...
/**
 * Test class for the Site_Kit_Consent_Management_Endpoint class.
 *
 * @group Endpoints
 *
 * @coversDefaultClass Yoast\WP\SEO\Dashboard\Infrastructure\Endpoints\Site_Kit_Consent_Management_Endpoint
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Site_Kit_Consent_Management_Endpoint_Test extends TestCase {
	...
	public function set_up() {
		$this->instance = new Site_Kit_Consent_Management_Endpoint();
	}
	...
	public function test_get_name() {
		$this->assertSame( 'siteKitConsentManagement', $this->instance->get_name() );
	}
	...
	public function test_get_route() {
		$this->assertSame( '/site_kit_manage_consent', $this->instance->get_route() );
	}
