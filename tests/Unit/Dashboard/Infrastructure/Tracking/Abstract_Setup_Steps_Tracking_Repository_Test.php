 ...
 */
abstract class Abstract_Site_Kit_Usage_Tracking_Repository_Test extends TestCase {

	/**
	 * Holds the instance.
	 *
	 * @var Site_Kit_Usage_Tracking_Repository
	 */
	protected $instance;
	...
	protected function set_up() {
		...
		$this->instance = new Site_Kit_Usage_Tracking_Repository( $this->options_helper );
	}
}
