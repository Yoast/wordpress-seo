...
/**
 * Abstract class for the Site_Kit_Usage_Tracking_Route tests.
 *
 * @group site_kit_usage_tracking_route
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
abstract class Abstract_Site_Kit_Usage_Tracking_Route_Test extends TestCase {

	/**
	 * Holds the instance.
	 *
	 * @var Site_Kit_Usage_Tracking_Route
	 */
	protected $instance;
	...
	protected function set_up() {
		...
		$this->instance = new Site_Kit_Usage_Tracking_Route(
			new Site_Kit_Usage_Tracking_Repository_Fake(),
