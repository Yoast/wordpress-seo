 ...
 */
final class Track_Setup_Steps_Set_Data_Throws_Exception_Test extends TestCase {
	...
	protected function set_up() {
		...
		$this->instance = new Setup_Steps_Tracking_Route(
			new Setup_Steps_Tracking_Repository_Fake( false, true ),
			$this->capability_helper
		);
	}

	/**
	 * Tests the track_setup_steps route response in case set data throws an exception.
	 *
	 * @return void
	 */
