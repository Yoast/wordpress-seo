...
/**
 * Tests the `store_token` method of the Refresh_Token_User_Meta_Repository class.
 *
 * @group ai-authorization
 *
 * @coversDefaultClass \Yoast\WP\SEO\AI_Authorization\Infrastructure\Refresh_Token_User_Meta_Repository
 */
final class Refresh_Token_User_Meta_Repository_Store_Token_Test extends Abstract_Refresh_Token_User_Meta_Repository_Test {
