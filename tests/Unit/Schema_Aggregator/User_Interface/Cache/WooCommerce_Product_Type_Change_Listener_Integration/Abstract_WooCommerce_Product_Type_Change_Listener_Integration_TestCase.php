...
use Yoast\WP\SEO\Schema_Aggregator\User_Interface\Cache\WooCommerce_Product_Type_Change_Listener_Integration;
...
abstract class Abstract_WooCommerce_Product_Type_Change_Listener_Integration_TestCase extends TestCase {
	 ...
	 * Holds the instance.
	 *
	 * @var WooCommerce_Product_Type_Change_Listener_Integration
	 */
	protected $instance;
