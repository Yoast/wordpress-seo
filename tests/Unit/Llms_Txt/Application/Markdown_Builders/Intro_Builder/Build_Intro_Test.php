...
final class Build_Intro_Test extends Abstract_Intro_Builder_Test {
	...
	public function test_build_intro() {
		...
		$built_intro = new Intro(
			'Generated by Yoast SEO v1.0, this is an llms.txt file, meant for consumption by LLMs.' . \PHP_EOL . \PHP_EOL . 'The XML sitemap of this website can be found by following %s.',
			$links
		);
