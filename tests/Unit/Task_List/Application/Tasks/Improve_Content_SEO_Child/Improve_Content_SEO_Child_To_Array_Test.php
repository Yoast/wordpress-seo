...
/**
 * Tests the to_array method of the Improve Content SEO Child task.
 *
 * @group task-list
 *
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Child_Tasks\Improve_Content_SEO_Child::to_array
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Improve_Content_SEO_Child_To_Array_Test extends Abstract_Improve_Content_SEO_Child_Test {
	...
	public function test_to_array() {
		...
		$this->parent_task
			...
			->andReturn( 'improve-content-seo-post' );
		...
		$this->assertSame( 'improve-content-seo-post-456', $result['id'] );
		...
		$this->assertSame( 'improve-content-seo-post', $result['parentTaskId'] );
	...
	public function test_to_array_when_completed() {
		...
		$this->assertSame( 'improve-content-seo-post-789', $result['id'] );
