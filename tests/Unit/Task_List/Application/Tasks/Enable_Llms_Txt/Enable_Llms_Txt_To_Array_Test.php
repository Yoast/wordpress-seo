...
final class Enable_Llms_Txt_To_Array_Test extends Abstract_Enable_Llms_Txt_Test {
	...
	public function test_to_array_completed() {
		...
		$expected_result = [
			...
			'about'        => '<p>Without llms.txt, AI platforms may not know how to treat your content. Enabling it helps communicate your preferences in a clearer way to AI tools.</p>',
		];
