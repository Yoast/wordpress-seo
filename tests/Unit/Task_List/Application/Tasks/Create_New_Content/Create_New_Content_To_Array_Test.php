...
final class Create_New_Content_To_Array_Test extends Abstract_Create_New_Content_Test {
	...
	public function test_to_array_completed() {
		...
		$expected_result = [
			...
			'about'        => '<p>Long gaps without new content slow down your traffic growth. Publishing regularly gives search engines and visitors a reason to return.</p><p>Plan a topic, write your post, and use the Yoast SEO and Readability Analysis to refine it before publishing.</p>',
		];
