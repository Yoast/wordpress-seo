...
/**
 * Test class for the Default Meta Descriptions to_array method.
 *
 * @group Default_Meta_Descriptions
 *
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_id
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_duration
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_priority
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_link
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_call_to_action
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_copy_set
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::to_array
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Default_Meta_Descriptions::get_is_completed
 * @covers Yoast\WP\SEO\Task_List\Domain\Components\Copy_Set::to_array
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Default_Meta_Descriptions_To_Array_Test extends Abstract_Default_Meta_Descriptions_Test {
	...
	public function test_to_array_with_no_children() {
		...
		$expected_result = [
			'id'           => 'default-meta-descriptions-post',
			'duration'     => 0,
			'priority'     => 'medium',
			'badge'        => null,
			'isCompleted'  => true,
	...
	public function test_to_array_when_child_task_exists_and_is_not_completed() {
		...
		$child_task = Mockery::mock( Default_Meta_Descriptions_Child::class );
		...
		$this->assertSame( 'default-meta-descriptions-post', $result['id'] );
	...
	public function test_get_id_includes_post_type() {
		...
		$this->assertSame( 'default-meta-descriptions-page', $this->instance->get_id() );
	}
}
