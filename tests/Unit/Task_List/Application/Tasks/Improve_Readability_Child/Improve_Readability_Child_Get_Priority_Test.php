...
/**
 * Tests the get_priority method of the Improve Readability Child task.
 *
 * @group task-list
 *
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Child_Tasks\Improve_Readability_Child::get_priority
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Improve_Readability_Child_Get_Priority_Test extends Abstract_Improve_Readability_Child_Test {
