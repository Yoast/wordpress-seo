...
/**
 * Base class for the Improve Readability Child task tests.
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
abstract class Abstract_Improve_Readability_Child_Test extends TestCase {
	...
	protected function set_up() {
		...
		$this->instance = new Improve_Readability_Child(
			$this->parent_task,
	 ...
	 *
	 * @return Improve_Readability_Child
	 */
	protected function create_instance_with_score( string $score ): Improve_Readability_Child {
		$content_item = new Content_Item_Score_Data( 123, 'Test Post Title', $score, 'post' );

		return new Improve_Readability_Child(
			$this->parent_task,
			$content_item
		);
	}
