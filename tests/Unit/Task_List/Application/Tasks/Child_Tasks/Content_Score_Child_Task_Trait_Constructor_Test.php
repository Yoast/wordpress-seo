...
use Mockery;
use Yoast\WP\SEO\Task_List\Application\Tasks\Child_Tasks\Content_Score_Child_Task_Trait;
...
/**
 * Tests the constructor of the Content_Score_Child_Task_Trait.
 *
 * @group task-list
 *
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Child_Tasks\Content_Score_Child_Task_Trait::__construct
 *
...
final class Content_Score_Child_Task_Trait_Constructor_Test extends TestCase {
	...
	public function test_constructor_throws_when_not_child_task() {
		...
		$content_item_score_data = new Content_Item_Score_Data( 123, 'Test', 'ok', 'post' );
		...
		new class($parent_task, $content_item_score_data) {
