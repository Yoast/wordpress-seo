...
/**
 * Tests the get_priority method of the Improve Content Readability Child task.
 *
 * @group task-list
 *
 * @covers Yoast\WP\SEO\Task_List\Application\Tasks\Child_Tasks\Improve_Content_Readability_Child::get_priority
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Improve_Content_Readability_Child_Get_Priority_Test extends Abstract_Improve_Content_Readability_Child_Test {

	/**
	 * Tests that a task with a bad readability score has high priority.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that a task with an ok readability score has medium priority.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that a task with a good readability score has medium priority.
	 *
