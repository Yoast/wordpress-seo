 ...
 *
 * @covers Yoast\WP\SEO\Dashboard\Application\Score_Groups\Readability_Score_Groups\Readability_Score_Groups_Repository::get_score_group
 * @covers Yoast\WP\SEO\Dashboard\Application\Score_Groups\Readability_Score_Groups\Readability_Score_Groups_Repository::get_no_score_group
 * @covers Yoast\WP\SEO\Dashboard\Application\Score_Groups\Abstract_Score_Groups_Repository::get_score_group
 *
 * @phpcs:disable Yoast.NamingConventions.ObjectNameDepth.MaxExceeded
 */
final class Readability_Score_Groups_Repository_Get_Score_Group_Test extends Abstract_Readability_Score_Groups_Repository_Test {

	/**
	 * Tests that a null score returns the No_Readability_Score_Group.
	 *
	 * @return void
	 */
	public function test_get_score_group_with_null_returns_no_score_group() {
		...
		$this->assertInstanceOf( No_Readability_Score_Group::class, $result );
		$this->assertSame( 'notAnalyzed', $result->get_name() );
	}

	/**
	 * Tests that a zero score returns the No_Readability_Score_Group.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that a bad score (1-40) returns the Bad_Readability_Score_Group.
	 *
	...
	public function test_get_score_group_with_bad_score( int $score ) {
		...
		$this->assertInstanceOf( Bad_Readability_Score_Group::class, $result );
	...
	/**
	 * Tests that an OK score (41-70) returns the Ok_Readability_Score_Group.
	 *
	...
	public function test_get_score_group_with_ok_score( int $score ) {
		...
		$this->assertInstanceOf( Ok_Readability_Score_Group::class, $result );
	...
	/**
	 * Tests that a good score (71-100) returns the Good_Readability_Score_Group.
	 *
	...
	public function test_get_score_group_with_good_score( int $score ) {
		...
		$this->assertInstanceOf( Good_Readability_Score_Group::class, $result );
	...
	/**
	 * Tests that a score out of range returns the No_Readability_Score_Group.
	 *
