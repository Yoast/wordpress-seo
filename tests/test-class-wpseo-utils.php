...
class WPSEO_Utils_Test extends WPSEO_UnitTestCase {
	 ...
	 *
	 * @covers WPSEO_Utils::is_yoast_seo_advanced_settings_page
	 */
	public function test_is_yoast_seo_advanced_settings_page_RETURNS_false_AND_IS_yoast_seo_page() {
		$current_page = 'wpseo_dashboard';

		$this->assertFalse( WPSEO_Utils::is_yoast_seo_advanced_settings_page( $current_page ) );
	}
	...
	public function test_is_yoast_seo_advanced_settings_page_RETURNS_true() {
		...
		$this->assertTrue( WPSEO_Utils::is_yoast_seo_advanced_settings_page($current_page) );
	}
