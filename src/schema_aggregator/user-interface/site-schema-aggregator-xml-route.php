...
class Site_Schema_Aggregator_Xml_Route implements Route_Interface {
	 ...
	 *
	 * @var Aggregate_Site_Schema_Map_Command
	 */
	 ...
	 * @param Aggregate_Site_Schema_Map_Command $aggregate_site_schema_map_command_handler The command handler.
	 */
	public function __construct( Config $config, Capability_Helper $capability_helper, Aggregate_Site_Schema_Map_Command $aggregate_site_schema_map_command_handler ) {
		$this->config                                = $config;
