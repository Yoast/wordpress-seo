...
class Free_Sparks_Route implements Route_Interface {
	...
	public function start(): WP_REST_Response {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\Free_Sparks\User_Interface\Free_Sparks_Route::start' );
	...
	public function can_edit_posts(): bool {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\Free_Sparks\User_Interface\Free_Sparks_Route::can_edit_posts' );
