...
class Free_Sparks_Handler implements Free_Sparks_Handler_Interface {
	...
	public function __construct( Options_Helper $options_helper ) {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Free_Sparks\Application\Free_Sparks_Handler::__construct' );
	...
	public function get( string $format = 'Y-m-d H:i:s' ): ?string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Free_Sparks\Application\Free_Sparks_Handler::get' );
	...
	public function start( ?int $timestamp = null ): bool {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Free_Sparks\Application\Free_Sparks_Handler::start' );
