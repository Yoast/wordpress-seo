...
class WordPress_URLs implements URLs_Interface {
	...
	public function get_license_url(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Generator\Infrastructure\WordPress_URLs::get_license_url' );
	...
	public function get_callback_url(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Generator\Infrastructure\WordPress_URLs::get_callback_url' );
	...
	public function get_refresh_callback_url(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Generator\Infrastructure\WordPress_URLs::get_refresh_callback_url' );
