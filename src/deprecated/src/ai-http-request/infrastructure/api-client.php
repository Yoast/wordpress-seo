...
class API_Client implements API_Client_Interface {
	...
	public function perform_request( string $action_path, $body, $headers, bool $is_post ): array {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\HTTP_Request\Infrastructure\API_Client::perform_request' );
	...
	public function get_request_timeout(): int {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\HTTP_Request\Infrastructure\API_Client::get_request_timeout' );
		/**
