...
abstract class Remote_Request_Exception extends Exception {
	...
	public function __construct( $message = '', $code = 0, $error_identifier = '', ?Throwable $previous = null ) {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.2', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Exceptions\Remote_Request_Exception::__construct' );
	...
	public function get_error_identifier(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.2', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Exceptions\Remote_Request_Exception::get_error_identifier' );
