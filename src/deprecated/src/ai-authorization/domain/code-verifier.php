...
class Code_Verifier {
	...
	public function __construct( string $code, int $created_at ) {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Authorization\Domain\Code_Verifier::__construct' );
	...
	public function get_code(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Authorization\Domain\Code_Verifier::get_code' );
	...
	public function get_created_at(): int {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Authorization\Domain\Code_Verifier::get_created_at' );
	...
	public function is_expired( int $validity_in_seconds ): bool {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.0', 'Yoast\WP\SEO\AI\Authorization\Domain\Code_Verifier::is_expired' );
