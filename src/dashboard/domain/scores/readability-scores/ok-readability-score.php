...
/**
 * This class describes an OK readability score.
 */
class Ok_Readability_Score extends Abstract_Readability_Score {

	/**
	 * Gets the name of the readability score.
	 *
	 * @return string The the name of the readability score.
	 */
