...
use Yoast\WP\SEO\Dashboard\Infrastructure\Search_Console\Cached_Site_Kit_Search_Console_Adapter;
...
class Top_Query_Repository implements Dashboard_Repository_Interface {
	 ...
	 * The adapter.
	 *
	 * @var Cached_Site_Kit_Search_Console_Adapter $site_kit_search_console_adapter
	 */
	 ...
	 * The constructor.
	 *
	 * @param Cached_Site_Kit_Search_Console_Adapter $site_kit_search_console_adapter The adapter.
	 */
	public function __construct( Cached_Site_Kit_Search_Console_Adapter $site_kit_search_console_adapter ) {
