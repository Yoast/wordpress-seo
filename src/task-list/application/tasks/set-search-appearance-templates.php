...
class Set_Search_Appearance_Templates extends Abstract_Post_Type_Task {
	...
	public function get_copy_set(): Copy_Set {
		...
		return new Copy_Set(
			...
			\sprintf( \__( 'Generic titles and descriptions make your results unclear in search. Templates ensure every %1$s has a clear, click-worthy snippet automatically. Go to Search appearance, choose your post type, and set default title and meta description patterns.', 'wordpress-seo' ), $post_type->name )
		);
	}
}
