	...
	public function get_copy_set(): Copy_Set {
		return new Copy_Set(
			...
			\sprintf(
				...
				\__( '%1$sLong gaps without new content slow down your traffic growth. Publishing regularly gives search engines and visitors a reason to return.%2$s%3$sPlan a topic, write your post, and use the %4$s SEO and Readability Analysis to refine it before publishing.%5$s', 'wordpress-seo' ),
				'<p>',
				'</p>',
				'<p>',
				'Yoast',
