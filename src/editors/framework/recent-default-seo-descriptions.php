...
/**
 * Describes if the Recent Default SEO Descriptions feature is enabled.
 */
class Recent_Default_SEO_Descriptions implements Analysis_Feature_Interface {

	public const NAME = 'recentDefaultSeoDescriptions';
	...
	/**
	 * If recent default SEO descriptions is enabled.
	 *
	 * @return bool If recent default SEO descriptions is enabled.
	 */
	public function is_enabled(): bool {
		return \count( $this->default_seo_data_collector->get_posts_with_default_seo_description() ) > 4;
	}
	...
	public function get_legacy_key(): string {
		return 'recentDefaultSeoDescriptions';
	}
}
