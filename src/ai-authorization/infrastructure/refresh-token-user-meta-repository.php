...
class Refresh_Token_User_Meta_Repository implements Refresh_Token_User_Meta_Repository_Interface {
	...
	public function get_token( int $user_id ): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.3', 'Yoast\WP\SEO\AI\Authorization\Infrastructure\Refresh_Token_User_Meta_Repository::get_token' );
	...
	public function store_token( int $user_id, string $value ): void {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.3', 'Yoast\WP\SEO\AI\Authorization\Infrastructure\Refresh_Token_User_Meta_Repository::store_token' );
	...
	public function delete_token( int $user_id ): void {
		\_deprecated_function( __METHOD__, 'Yoast SEO 26.3', 'Yoast\WP\SEO\AI\Authorization\Infrastructure\Refresh_Token_User_Meta_Repository::delete_token' );
