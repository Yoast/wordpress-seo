...
class Response {
	...
	public function get_body() {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Response::get_body' );
		return $this->body;
	}
	...
	public function get_response_code(): int {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Response::get_response_code' );
	...
	public function get_message(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Response::get_message' );
		return $this->message;
	}
	...
	public function get_error_code(): string {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Response::get_error_code' );
	...
	public function get_missing_licenses(): array {
		\_deprecated_function( __METHOD__, 'Yoast SEO ', 'Yoast\WP\SEO\AI\HTTP_Request\Domain\Response::get_missing_licenses' );
