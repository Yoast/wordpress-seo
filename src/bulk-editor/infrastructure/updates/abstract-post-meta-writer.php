...
abstract class Abstract_Post_Meta_Writer {
	...
	public function write_title( int $post_id, string $title ): void {
		$this->meta_helper->set_value( $this->get_title_meta_key(), $this->sanitize( $title ), $post_id );
	}
	...
	public function write_description( int $post_id, string $description ): void {
		$this->meta_helper->set_value( $this->get_description_meta_key(), $this->sanitize( $description ), $post_id );
	}
