...
class Print_QR_Code_Embed implements Integration_Interface {
	...
	public function generate_qr_code() {
		...
		$url   = \urlencode( YoastSEO()->meta->for_current_page()->canonical );
		echo '<div class="yoast_seo_print_only"><img src="' . trailingslashit( get_site_url() ) . '?nonce=' . $nonce . '&yoast_qr_code=' . $url . '" width="150" height="150" alt="QR Code for current page\'s URL." /></div>';
	}
}
