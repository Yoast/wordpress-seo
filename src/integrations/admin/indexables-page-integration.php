		...
		$this->admin_asset_manager->localize_script(
			...
			[
				...
				'shortlinks'               => [
					...
					'howToWriteABlogPost'          => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-how-to-write-a-blog-post' ),
					'friendlyBlogPost'             => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-seo-friendly-blog-post' ),
					'keywordResearchUltimateGuide' => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-keyword-research-ultimate-guide' ),
					'howToStartABlog'              => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-how-to-start-a-blog' ),
					'seoCopywritingMustRead'       => $this->shortlinker->build_shortlink( 'https://yoa.st/indexables-seo-copywriting-must-reads' ),
