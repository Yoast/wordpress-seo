...
class Context_Helper {
	...
	private function build_data() {
		...
		$this->canonical   = $this->model->canonical;
		$this->title       = $this->model->title;
		$this->description = $this->model->description;
		$this->id          = $this->model->object_id;

		// Site level variables.
		$this->site_name = $this->set_site_name();
		$this->site_url  = \trailingslashit( \WPSEO_Utils::home_url() );
	...
	private function set_site_represents_reference() {
		...
		if ( $this->site_represents === 'person' ) {
			$this->site_represents_reference = array( '@id' => $this->id_helper->get_user_schema_id( $this->site_user_id, $this ) );
		}

		if ( $this->site_represents === 'company' ) {
			$this->site_represents_reference = array( '@id' => $this->site_url . $this->id_helper->organization_hash );
		}
	}
