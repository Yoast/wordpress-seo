...
class Request_Helper {
	 ...
	 * @param string|null $default_value The default value if the query variable is undefined.
	 *
	 * @return string|null The value of the query variable.
	 */
	public function get_variable_from_query_string( $variable_name, $default_value = null ) {
