	...
	protected function get_message( $reason ) {
		switch ( $reason ) {
			...
			case Indexing_Reasons::REASON_ATTACHMENTS_MADE_ENABLED:
				$text = \esc_html__( 'It looks like you\'ve disabled the redirection of attachment URLs to the attachment itself. We recommend that you help us to re-analyze your site by running the SEO data optimization. ', 'wordpress-seo' );
				break;
			default:
