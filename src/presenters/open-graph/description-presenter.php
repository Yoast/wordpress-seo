...
class Description_Presenter extends Abstract_Indexable_Tag_Presenter {
	 ...
	 */
	public function get() {
		$meta_description = $this->replace_vars( $this->presentation->open_graph_description );
		 ...
		 */
		$meta_description = \apply_filters( 'wpseo_opengraph_desc', $meta_description, $this->presentation );
