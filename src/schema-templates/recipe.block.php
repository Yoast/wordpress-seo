...
{{sidebar-duration name="cook-time" output=false label="<?php _e( "Cook time", "wordpress-seo" ); ?>" }}
{{sidebar-duration name="prep-time" output=false label="<?php _e( "Preparation time", "wordpress-seo" ); ?>" }}
