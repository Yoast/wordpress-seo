...
?>
{{block name="yoast/recipe-description" title="<?php \esc_attr_e( 'Recipe description', 'wordpress-seo' ); ?>" category="yoast-recommended-recipe-blocks" description="<?php \esc_attr_e( 'A description of the recipe.', 'wordpress-seo' ); ?>" icon="<?php echo Icons::heroicons_document_text(); ?>" supports={"multiple": false} }}
