...
/**
 * Meta tags context adapter for author archive pages.
 */
class Author_Archive_Meta_Tags_Context_Memoizer_Adapter extends Abstract_Meta_Tags_Context_Memoizer_Adapter {

	/**
	 * Gets fields specific to author archive pages.
	 *
	 * @param Meta_Tags_Context $context The meta tags context.
	 * @return array<string, string|int|bool> The author archive specific fields.
	 */
