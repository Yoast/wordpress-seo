	...
	private function set_site_represents_variables() {
		...
		switch ( $this->site_represents ) {
			case 'company':
				...
				/**
				 * Filter: 'yoast_free_company_name' - Allows filtering company name
				 *
				 * @api string $company_name.
				 */
				$this->company_name = apply_filters( 'yoast_free_company_name', $company_name );
				...
				/**
				 * Filter: 'yoast_free_company_logo_id' - Allows filtering company logo id
				 *
				 * @api integer $company_logo_id.
				 */
				$this->company_logo_id = apply_filters( 'yoast_free_company_logo_id', $company_logo_id );
