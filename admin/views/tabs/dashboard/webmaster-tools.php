...
$yform->textinput( 'msverify', '<a target="_blank" href="' . esc_url( 'https://www.bing.com/webmaster/?rfp=1#/Dashboard/?url=' . urlencode( str_replace( 'http://', '', get_bloginfo( 'url' ) ) ) ) . '">' . __( 'Bing Webmaster Tools', 'wordpress-seo' ) . '</a>' );
...
$yform->textinput( 'yandexverify', '<a target="_blank" href="https://webmaster.yandex.com/sites/add/">' . __( 'Yandex Webmaster Tools', 'wordpress-seo' ) . '</a>' );
