...
?>
	...
	<p>
		<a class="button button-secondary"
		   href="<?php echo esc_url( admin_url( 'admin.php?page=' . WPSEO_Admin::PAGE_IDENTIFIER . '&wpseo_restart_tour=1' ) ); ?>"><?php esc_html_e( 'Start Tour', 'wordpress-seo' ); ?></a>
	</p>
...
<p>
	<a class="button button-secondary"
	   href="<?php echo esc_url( admin_url( 'admin.php?page=' . WPSEO_Admin::PAGE_IDENTIFIER . '&intro=1' ) ); ?>"><?php esc_html_e( 'View Changes', 'wordpress-seo' ); ?></a>
</p>
