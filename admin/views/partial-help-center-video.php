...
if ( ! empty( $tab_video_url ) ) :
	...
	<div class="wpseo-tab-video__panel wpseo-tab-video__panel--video">
		<div class="wpseo-tab-video__data" data-url="<?php echo esc_url( $tab_video_url ) ?>"></div>
	</div>
	<div class="wpseo-tab-video__panel wpseo-tab-video__panel--text">
		...
		if ( ! defined( 'WPSEO_PREMIUM_PLUGIN_FILE' ) ) :
			...
			<div class="wpseo-tab-video__panel__textarea">
				<h3><?php esc_html_e( 'Need more help?', 'wordpress-seo' ); ?></h3>
				<?php /* translators: %s expands to Yoast SEO Premium */ ?>
				<p><?php printf( esc_html__( 'If you buy %s you\'ll get access to our support team and bonus features!', 'wordpress-seo' ), 'Yoast SEO Premium' ); ?></p>
				<?php /* translators: %s expands to Yoast SEO Premium */ ?>
				<p><a href="https://yoa.st/seo-premium-vt"
				      target="_blank"><?php printf( esc_html__( 'Get %s &raquo;', 'wordpress-seo' ), 'Yoast SEO Premium' ); ?></a>
				</p>
			</div>
			<?php
		endif;
		...
		<div class="wpseo-tab-video__panel__textarea">
			...
			<p><a href="https://yoa.st/wordpress-training-vt"
			      target="_blank"><?php printf( esc_html__( 'Enroll in the %s training &raquo;', 'wordpress-seo' ), 'Yoast SEO for WordPress' ); ?></a>
			</p>
		</div>
	</div>
	<?php
