...
echo '<p>' . sprintf( __( 'If you choose a permalink for your posts with %s, or anything else but a / on the end, this will force WordPress to add a trailing slash to non-post pages nonetheless.', 'wordpress-seo' ), '<code>.html</code>' ) . '</p>';
...
echo '<p>' . sprintf( __( 'If you use Google Analytics campaign parameters starting with %s, check this box. You shouldn\'t use these btw, you should instead use the hash tagged version instead.', 'wordpress-seo' ), '<code>?utm_</code>' ) . '</p>';
