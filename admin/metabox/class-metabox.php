...
class WPSEO_Metabox extends WPSEO_Meta {
	...
	public static function translate_meta_boxes() {
		...
		WPSEO_Meta::$meta_fields['advanced']['wordproof_timestamp']['description']  = __( 'Use WordProof to timestamp this page to comply with legal regulations and join the fight for a more transparent and accountable internet.', 'wordpress-seo' );
