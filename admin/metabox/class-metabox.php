...
class WPSEO_Metabox extends WPSEO_Meta {
	...
	private function get_buy_premium_link() {
		return sprintf( "<div class='%s'><a target='_blank' rel='noreferrer noopener' href='https://yoa.st/add-keywords-popup' class='wpseo-meta-section-link'><span class='dashicons dashicons-star-filled wpseo-buy-premium'></span>%s</a></div>",
