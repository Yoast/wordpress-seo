...
$content .= $wpseo_admin_pages->checkbox( 'trailingslash', __( 'Enforce a trailing slash on all category and tag URLs', 'wordpress-seo' ) );
...
$content .= $wpseo_admin_pages->checkbox( 'redirectattachment', __( 'Redirect attachment URLs to parent post URL.', 'wordpress-seo' ) );
$content .= '<p class="desc">' . __( 'Attachments to posts are stored in the database as posts. This means they\'re accessible under their own URLs if you do not redirect them. Enabling this will redirect them to the post they were attached to.', 'wordpress-seo' ) . '</p>';
...
$content .= $wpseo_admin_pages->checkbox( 'cleanpermalinks', __( 'Redirect ugly URLs to clean permalinks. (Not recommended in many cases!)', 'wordpress-seo' ) );
...
$content = $wpseo_admin_pages->checkbox( 'cleanpermalink-googlesitesearch', __( 'Prevent cleaning out Google Site Search URLs.', 'wordpress-seo' ) );
$content .= '<p class="desc">' . __( 'Google Site Search URLs look weird (and ugly), but if you\'re using Google Site Search you probably do not want them cleaned out.', 'wordpress-seo' ) . '</p>';
