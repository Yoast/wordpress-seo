	...
	if ( is_array( $post_types ) && $post_types !== array() ) {
		foreach ( $post_types as $pt ) {
			...
			if ( $warn === true ) {
				...
				echo '<p class="error-message">' . __( 'As you are redirecting attachment URL\'s to parent post URL\'s, these settings will currently only have an effect on unattached media items!', 'wordpress-seo' ) . '</p>';
