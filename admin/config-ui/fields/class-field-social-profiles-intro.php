...
class WPSEO_Config_Field_Social_Profiles_Intro extends WPSEO_Config_Field {
 ...
 sharing options in the %1$s Social settings. %2$sMore information%3$s about these options.', 'wordpress-seo' ),
			'Yoast SEO',
			'<a target="_blank" href="' . WPSEO_Shortlinker::get( 'https://yoa.st/1ey' ) . '">',
			'</a>'
		);
