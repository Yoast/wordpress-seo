...
/**
 * Class WPSEO_Config_Field_Conditional_Mailchimp_Signup
 */
class WPSEO_Config_Field_Conditional_Mailchimp_Signup extends WPSEO_Config_Field {

	/**
	 * WPSEO_Config_Field_Conditional_Mailchimp_Signup constructor.
	 */
	public function __construct() {
		parent::__construct( 'conditionalMailchimpSignup', 'ConditionalMailchimpSignup' );
