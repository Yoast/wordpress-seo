...
class WPSEO_Expose_Shortlinks implements WPSEO_WordPress_Integration {
	...
	private $shortlinks = [
		...
		'shortlinks-insights-sidebar-text_formality_info_free'      => 'https://yoa.st/formality-sidebar-free',
		'shortlinks-insights-metabox-text_formality_info_free'      => 'https://yoa.st/formality-metabox-free',
        'shortlinks-insights-sidebar-text_formality_info_premium'   => 'https://yoa.st/formality-sidebar',
		'shortlinks-insights-metabox-text_formality_info_premium'   => 'https://yoa.st/formality-metabox'
	];
