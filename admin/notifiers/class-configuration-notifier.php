...
class WPSEO_Configuration_Notifier implements WPSEO_Notifier {
	...
	private function notification( $title, $content, $show_dismissal = false ) {
		$image_url = esc_url( plugin_dir_url( WPSEO_FILE ) . 'images/new-to-configuration-notice.svg' );

		return WPSEO_Notification::display( $title, $content, $image_url, $show_dismissal );
	}
}
