...
abstract class WPSEO_Base_Menu implements WPSEO_WordPress_Integration {
	...
	protected function get_license_page_title() {
		...
		if ( $title === null ) {
			$title =  YoastSEO()->classes->get( Promotion_Manager::class )->is( 'black_friday_2023' ) ?
			__( 'Premium', 'wordpress-seo' ) . '<span class="yoast-menu-bf-sale-badge">' . __( '30% OFF', 'wordpress-seo' ) . '</span>' :
