...
function wpseo_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'wpseo_internallinks[breadcrumbs-home]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-breadcrumbs-home' , array(
    ...
    $wp_customize->add_setting( 'wpseo_internallinks[breadcrumbs-prefix]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-breadcrumbs-prefix' , array(
    ...
    $wp_customize->add_setting( 'wpseo_internallinks[breadcrumbs-archiveprefix]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-breadcrumbs-archiveprefix' , array(
    ...
    $wp_customize->add_setting( 'wpseo_internallinks[breadcrumbs-searchprefix]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-breadcrumbs-searchprefix' , array(
    ...
    $wp_customize->add_setting( 'wpseo_internallinks[breadcrumbs-404crumb]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-breadcrumbs-404crumb' , array(
    ...
    $wp_customize->add_setting( 'wpseo_social[twitter_site]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-twitter-site' , array(
    ...
    $wp_customize->add_setting( 'wpseo_social[instagram_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    // Twitter Site Controls
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-instagram-url' , array(
    ...
    $wp_customize->add_setting( 'wpseo_social[linkedin_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-linkedin-url' , array(
    ...
    $wp_customize->add_setting( 'wpseo_social[myspace_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-myspace-url' , array(
    ...
    $wp_customize->add_setting( 'wpseo_social[pinterest_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_setting( 'wpseo_social[youtube_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-youtube-url' , array(
    ...
    // Google+ Site Setting
    $wp_customize->add_setting( 'wpseo_social[google_plus_url]' , array(
            'default'     => '',
            'type' => 'option',
            'transport'   => 'refresh',
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'wpseo-googleplus-url' , array(
