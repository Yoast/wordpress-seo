...
class WPSEO_GSC_Category_Filters {
	...
	private function set_filter_values() {
		...
		$this->set_filter_value( 'roboted', __( 'Blocked', 'wordpress-seo' ), __( 'Googlebot could access your site, but certain URLs are blocked for Googlebot in your robots.txt file. This block could either be for all Googlebots or even specifically for Googlebot-mobile.', 'wordpress-seo' ) );
