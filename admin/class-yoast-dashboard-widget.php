...
class Yoast_Dashboard_Widget implements WPSEO_WordPress_Integration {
	...
	public function enqueue_dashboard_assets() {
		...
		$this->asset_manager->localize_script( 'dashboardWidget', 'wpseoDashboardWidgetL10n', $this->localize_dashboard_script() );
		$yoast_components_l10n = new WPSEO_Admin_Asset_Yoast_Components_L10n();
		$yoast_components_l10n->localize_script( 'dashboardWidget' );
