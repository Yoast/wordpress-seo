...
class Yoast_Plugin_Conflict {
	...
	protected function set_error( $plugin_section, $readable_plugin_section ) {
		...
		$error_message .= "<input type='hidden' name='conflict_data' value= '" . $conflict_data . "'  />";
		...
		Yoast_Notification_Center::get()->add_notification(
			new Yoast_Notification( $error_message, array( 'type' => 'error yoast-dismissible', 'id' => 'wpseo-dismiss-plugin-conflict', 'nonce' => wp_create_nonce( 'dismiss-plugin-conflict' ) ) )
		);
	}
