...
class WPSEO_Metabox_Formatter {
	...
	private function get_defaults() {
		...
		$enabled_features_repo = YoastSEO()->classes->get( Analysis_Features_Repository::class );

		$enabled_features = $enabled_features_repo->get_analysis_features()->parse_to_legacy_array();
