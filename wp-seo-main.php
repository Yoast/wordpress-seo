...
function wpseo_auto_load( $class ) {
	...
	if ( $classes === null ) {
		$classes = array(
			...
			'wpseo_option'                       => WPSEO_PATH . 'inc/class-wpseo-option.php',
			'wpseo_option_wpseo'                 => WPSEO_PATH . 'inc/class-wpseo-option-wpseo.php',
			'wpseo_option_permalinks'            => WPSEO_PATH . 'inc/class-wpseo-option-permalinks.php',
			'wpseo_option_titles'                => WPSEO_PATH . 'inc/class-wpseo-option-titles.php',
			'wpseo_option_social'                => WPSEO_PATH . 'inc/class-wpseo-option-social.php',
			'wpseo_option_rss'                   => WPSEO_PATH . 'inc/class-wpseo-option-rss.php',
			'wpseo_option_internallinks'         => WPSEO_PATH . 'inc/class-wpseo-option-internallinks.php',
			'wpseo_option_xml'                   => WPSEO_PATH . 'inc/class-wpseo-option-xml.php',
			'wpseo_option_ms'                    => WPSEO_PATH . 'inc/class-wpseo-option-ms.php',
			'wpseo_taxonomy_meta'                => WPSEO_PATH . 'inc/class-wpseo-taxonomy-meta.php',
