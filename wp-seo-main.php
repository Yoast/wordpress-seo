...
function wpseo_init_rest_api() {
	...
	if ( WPSEO_Utils::is_api_available() ) {
		...
		$configuration_notification_service  = new WPSEO_Configuration_Notification_Service();
		$configuration_notification_endpoint = new WPSEO_Configuration_Notification_Endpoint( $configuration_notification_service );
		$configuration_notification_endpoint->register();
	}
}
