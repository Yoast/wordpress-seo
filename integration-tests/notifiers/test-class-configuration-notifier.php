...
class WPSEO_Configuration_Notifier_Test extends WPSEO_UnitTestCase {
	...
	public function test_notify_when_onboarding_wizard_notice_wont_be_shown() {
		...
		$this->assertEquals( '<div class="yoast-paper"><div class="yoast-paper__configuration-wizard"><div class="yoast-paper__configuration-wizard-content"><h2>SEO settings configured</h2><p>If you want to double-check your Yoast SEO settings, or change something, you can always reopen the configuration wizard.</p><a href="http://example.org/wp-admin/admin.php?page=wpseo_configurator" class="yoast-button yoast-button--primary">Reopen configuration wizard</a></div><img src="http://example.org/wp-content/plugins/wordpress-seo/images/new-to-configuration-notice.svg" alt="" /></div></div>', $notifier->notify() );
	}
