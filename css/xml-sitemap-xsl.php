...
?>
	...
	<xsl:template match="/">
		...
		<div id="content">
			<h1>XML Sitemap</h1>
			<p class="expl">
				Generated by <a href="<?php echo esc_url( WPSEO_Shortlinker::get( 'https://yoa.st/1y5' ) ) ?>" target="_blank" rel="noopener noreferrer">Yoast</a> <a href="<?php echo esc_url( WPSEO_Shortlinker::get( 'https://yoa.st/1y6' ) ) ?>" target="_blank" rel="noopener noreferrer">SEO</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
