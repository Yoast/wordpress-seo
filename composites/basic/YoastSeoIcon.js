...
const YoastSeoIcon = ( props ) => {
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" className="yoast-wizard__logo" style={{ width: props.width, height: props.height }}>
			<g id="BG">
...
YoastSeoIcon.propTypes = {
	width: PropTypes.number,
	height: PropTypes.number,
};

YoastSeoIcon.defaultProps = {
	width: 100,
	height: 100,
};
