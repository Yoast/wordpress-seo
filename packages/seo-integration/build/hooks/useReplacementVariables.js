...
export const useReplacementVariables = () => {
  ...
  const cachedValues = map((_cache$current = cache.current) === null || _cache$current === void 0 ? void 0 : _cache$current.replacementVariables, "value").join(""); // Set the cache when any value changed, or when it was not set before.
...
//# sourceMappingURL=useReplacementVariables.js.map