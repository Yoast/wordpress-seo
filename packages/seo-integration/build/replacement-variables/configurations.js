...
export const date = {
  ...
  getReplacement: () => new Date(select(SEO_STORE_NAME).selectDate()).toLocaleDateString( // eslint-disable-next-line no-undefined
  undefined, {
    day: "numeric",
    month: "long",
    year: "numeric"
...
export const excerpt = {
  ...
  getReplacement: () => {
    ...
    const currentContent = select(SEO_STORE_NAME).selectContent(); // Limit the excerpt to 80 characters for Japanese and to 156 characters for other languages.
