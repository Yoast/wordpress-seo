...
const useBaseUrl = (permalink, slug) => {
  return useMemo(() => {
    ...
    baseUrl = baseUrl.replace(new RegExp(slug + "$"), ""); // Enforce ending with a slash because of the internal handling in the SnippetEditor component.
...
const GooglePreviewContainer = _ref => {
  let {
    as: Component,
    ...restProps
  } = _ref;
...
//# sourceMappingURL=google-preview-container.js.map