...
* Information on the the scoring system of the assessments can be found [here](https://github.com/Yoast/wordpress-seo/packages/yoastseo/src/scoring/assessments/SCORING READABILITY.md)
