 ...
 */
export function isFollowedAndPrecededByException(words: string[], nonInclusivePhrase: string[], precedingExceptions: string[], followingExceptions: string[]): Function;
/**
 ...
 * @returns {function} A callback that checks whether a non-inclusive term is both preceded and followed by an exception.
 */
export function isNotFollowedAndPrecededByException(words: string[], nonInclusivePhrase: string[], precedingExceptions: string[], followingExceptions: string[]): Function;
