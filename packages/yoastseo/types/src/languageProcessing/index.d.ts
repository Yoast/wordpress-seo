...
import { stripBlockTagsAtStartEnd } from "./helpers/sanitize/stripHTMLTags";
...
export { AbstractResearcher, transliterate, replaceDiacritics, createRegexFromArray, imageInText, stripSpaces, baseStemmer, getWords, flattenSortLength, indices, buildFormRule, createRulesFromArrays, createSingleRuleFromArray, matchRegularParticiples, directPrecedenceException, precedenceException, nonDirectPrecedenceException, findMatchingEndingInArray, regexHelpers, exceptionListHelpers, stemHelpers, areWordsInSentence, values, getClauses, getClausesSplitOnStopWords, stripHTMLTags, stripBlockTagsAtStartEnd, countMetaDescriptionLength, sanitizeString, removePunctuation, getLanguage, getSentences, getFieldsToMark, unifyAllSpaces, normalizeHTML, collectMarkingsInSentence, normalizeSingle, parseSynonyms, mergeListItems, findWordFormsInString, markWordsInSentences, helpers, researches };
