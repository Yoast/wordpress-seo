import OutboundLinksAssessment from "../../src/languages/legacy/assessments/seo/OutboundLinksAssessment.js";
...
describe( "Tests outbound links assessment", function() {
	...
	it( "Tests a paper without outbound links", function() {
		...
		const assessment = linkStatisticAssessment.getResult( mockPaper, factory.buildMockResearcher( { externalTotal: 0 } ), i18n );
