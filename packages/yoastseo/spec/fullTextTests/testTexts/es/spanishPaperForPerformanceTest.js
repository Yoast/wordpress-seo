 ...
 * in different languages. The paper is actually a Russian paper with a Spanish locale, so not representative of a real life
...
import content from "./spanishPaperForPerformanceTest.html";

const name = "spanishPaperForPerformanceTest";
