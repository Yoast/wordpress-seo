...
import content from "./spanishPaper3.html";

const name = "spanishPaper3";

const paper = new Paper( content, {
	keyword: "El lugar de culto religioso más antiguo del mundo",
	synonyms: "Göbekli Tepe",
	description: "Göbekli Tepe (en turco, Colina panzuda) es un antiguo santuario",
	title: "Göbekli Tepe - un antiguo santuario",
	titleWidth: 450,
	locale: "es_ES",
	permalink: "https://es.wikipedia.org/wiki/Göbekli-Tepe",
	url: "Göbekli-Tepe",
} );
...
const expectedResults = {
	...
	textLength: {
		isApplicable: true,
		score: 9,
		resultText: "<a href='https://yoa.st/34n' target='_blank'>Text length</a>: The text contains 526 words. Good job!",
	},
	externalLinks: {
		isApplicable: true,
		score: 3,
	...
	titleKeyword: {
		isApplicable: true,
		score: 2,
		resultText: "<a href='https://yoa.st/33g' target='_blank'>Keyphrase in title</a>: Not all the words from your keyphrase \"El lugar de culto religioso más antiguo del mundo\" appear in the SEO title. <a href='https://yoa.st/33h' target='_blank'>For the best SEO results write the exact match of your keyphrase in the SEO title, and put the keyphrase at the beginning of the title</a>.",
	},
	titleWidth: {
		isApplicable: true,
		score: 9,
