...
const expectedResults = {
	...
	fleschReadingEase: {
		isApplicable: true,
		score: 9,
		resultText: "<a href='https://yoa.st/34r' target='_blank'>Flesch Reading Ease</a>: The copy scores 74.4 in the test, which is considered fairly easy to read. Good job!",
	},
	subheadingsTooLong: {
		isApplicable: true,
		score: 9,
	...
	wordComplexity: {
		isApplicable: true,
		score: 6,
		resultText: "<a href='https://yoa.st/4ls' target='_blank'>Word complexity</a>: 10.54% of the words in your text is considered complex. " +
