 ...
 * in different languages. The paper is actually a Russian paper with an English locale, so not representative of a real life
...
import content from "./englishPaperForPerformanceTest.html";

const name = "englishPaperForPerformanceTest";
...
const expectedResults = {
	...
	keywordDensity: {
		isApplicable: true,
		score: 4,
		resultText: "Keyphrase density</a>: The focus keyphrase was found 5 times. That's less than the recommended minimum of 6 times for a text of this length. Focus on your keyphrase</a>!",
	},
	...
	fleschReadingEase: {
		isApplicable: true,
		score: 9,
		resultText: "Flesch Reading Ease</a>: The copy scores 100 in the test, which is considered very easy to read. Good job!",
	},
	subheadingsTooLong: {
		isApplicable: true,
		score: 3,
	...
	textSentenceLength: {
		isApplicable: true,
		score: 3,
		resultText: "Sentence length</a>: 30.3% of the sentences contain more than 20 words, which is more than the recommended maximum of 25%. Try to shorten the sentences</a>.",
	},
	textTransitionWords: {
		isApplicable: true,
		score: 3,
		resultText: "Transition words</a>: Only 2.6% of the sentences contain transition words, which is not enough. Use more of them</a>.",
	},
	passiveVoice: {
		isApplicable: true,
		score: 9,
