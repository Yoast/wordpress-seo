...
import content from "./slovakPaper1.html";
...
const expectedResults = {
	...
	keywordDensity: {
		isApplicable: true,
		score: 9,
		resultText: "Keyphrase density</a>: The focus keyphrase was found 10 times. This is great!",
	},
	...
	textLength: {
		isApplicable: true,
		score: 9,
		resultText: "Text length</a>: The text contains 519 words. Good job!",
	},
	externalLinks: {
		isApplicable: true,
		score: 7,
		resultText: "Outbound links</a>: All outbound links on this page are nofollowed." +
			" Add some normal links</a>.",
	},
	internalLinks: {
		isApplicable: true,
		score: 9,
	...
	textTransitionWords: {
		isApplicable: true,
		score: 3,
		resultText: "Transition words</a>: Only 12.6% of the sentences contain transition words," +
