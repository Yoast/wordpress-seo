...
import content from "./indonesianPaper1.html";
...
const expectedResults = {
	...
	keywordDensity: {
		isApplicable: true,
		score: 4,
		resultText: "Keyphrase density</a>: The focus keyphrase was found 0 times. That's less than the recommended minimum of 16 times for a text of this length. Focus on your keyphrase</a>!",
	},
	...
	textLength: {
		isApplicable: true,
		score: 9,
		resultText: "Text length</a>: The text contains 3216 words. Good job!",
	},
	externalLinks: {
		isApplicable: true,
		score: 3,
	...
	subheadingsTooLong: {
		isApplicable: true,
		score: 3,
		resultText: "Subheading distribution</a>: 5 sections of your text are longer than 300 words and are not separated by any subheadings. Add subheadings to improve readability</a>.",
	},
	...
	textTransitionWords: {
		isApplicable: true,
		score: 6,
		resultText: "Transition words</a>: Only 20.1% of the sentences contain transition words, which is not enough. Use more of them</a>.",
	},
	passiveVoice: {
		isApplicable: true,
		score: 6,
		resultText: "Passive voice</a>: 11.3% of the sentences contain passive voice, which is more than the recommended maximum of 10%. Try to use their active counterparts</a>.",
	},
	textPresence: {
		score: 0,
		resultText: "",
