...
const expectedResults = {
	...
	keywordDensity: {
		isApplicable: true,
		score: 4,
		resultText: "Keyphrase density</a>: The focus keyphrase was found 4 times. That's less" +
			" than the recommended minimum of 22 times for a text of this length. Focus on your" +
			" keyphrase</a>!",
	},
	...
	metaDescriptionLength: {
		isApplicable: true,
		score: 6,
		resultText: "Meta description length</a>: The meta description is too short (under" +
			" 120 characters). Up to 156 characters are available. Use the space</a>!",
	},
	subheadingsKeyword: {
		isApplicable: true,
		score: 3,
	...
	textLength: {
		isApplicable: true,
		score: 9,
		resultText: "Text length</a>: The text contains 5819 words. Good job!",
	},
	externalLinks: {
		isApplicable: true,
		score: 3,
	...
	titleKeyword: {
		...
		resultText: "Keyphrase in title</a>: Not all the words from your keyphrase" +
			" \"Definições de música\" appear in the SEO title. For the best SEO results write" +
	...
	keyphraseDistribution: {
		isApplicable: true,
		score: 6,
		resultText: "Keyphrase distribution</a>: Uneven. Some parts of your text do not contain" +
			" the keyphrase or its synonyms. Distribute them more evenly</a>.",
	},
	fleschReadingEase: {
		isApplicable: true,
		score: 3,
		resultText: "Flesch Reading Ease</a>: The copy scores 38.9 in the test, which is considered" +
	...
	subheadingsTooLong: {
		isApplicable: true,
		score: 3,
		resultText: "Subheading distribution</a>: 5 sections of your text are longer than 300 words" +
			" and are not separated by any subheadings. Add subheadings to improve readability</a>.",
	},
	textParagraphTooLong: {
		isApplicable: true,
		score: 3,
		resultText: "Paragraph length</a>: 10 of the paragraphs contain more than the recommended" +
	...
	textTransitionWords: {
		isApplicable: true,
		score: 6,
		resultText: "Transition words</a>: Only 25.3% of the sentences contain transition words," +
			" which is not enough. Use more of them</a>.",
	},
	passiveVoice: {
		isApplicable: true,
		score: 6,
		resultText: "Passive voice</a>: 14.4% of the sentences contain passive voice, which is more" +
			" than the recommended maximum of 10%. Try to use their active counterparts</a>.",
	},
	textPresence: {
		isApplicable: true,
		score: 0,
