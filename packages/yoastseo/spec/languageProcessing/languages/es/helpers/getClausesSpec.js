...
describe( "splits Spanish sentences into clauses", function() {
	...
	it( "doesn't return clauses when there is a sentence breaker within a word", function() {
	...
	it( "returns clauses when there is a stop characters followed by a space/punctuation mark", function() {
	...
	it( "doesn't return clauses when there is a stop characters that is not followed by a space/punctuation mark", function() {
