...
describe( "counts words in a string", function() {
	it( "returns the number of words", function() {
		...
		expect( wordCountFunction( " انتشار کتابی درباره خفن‌ترین آزمایش های تاریخ علم، توجه رسانه‌ها " +
			"را به خود جلب کردیل‌ها در اسید و دیگر آزمایش‌های خفن عل این عنوان کتابی است که چند" ) ).toBe( 28 );
