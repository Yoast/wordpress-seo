		...
		const testData = [
			{
				...
				expectedFeedback: "Be careful when using <i>lame</i> as it is potentially harmful. " +
				"Unless you are referring to an object, considering using an alternative. For example, <i>boring, lousy, unimpressive, sad, corny</i>. If " +
					"referring to someone's disability, use an alternative such as <i>person with a disability, person who has difficulty with walking</i>. " +
					"<a href='https://yoa.st/inclusive-language-disability' target='_blank'>Learn more.</a>",
				expectedScore: 6,
			},
			{
				...
				expectedFeedback: "Be careful when using <i>lamer</i> as it is potentially harmful. Unless you are " +
					"referring to an object, considering using an alternative. For example, <i>more boring, lousier, more unimpressive, sadder, cornier</i>. " +
					"<a href='https://yoa.st/inclusive-language-disability' target='_blank'>Learn more.</a>",
				expectedScore: 6,
			},
			{
				...
				expectedFeedback: "Be careful when using <i>lamest</i> as it is potentially harmful. Unless you are " +
					"referring to an object, considering using an alternative. For example, <i>most boring, lousiest, most unimpressive, saddest, corniest</i>. " +
					"<a href='https://yoa.st/inclusive-language-disability' target='_blank'>Learn more.</a>",
				expectedScore: 6,
			},
		];
