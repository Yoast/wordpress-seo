import createRegexFromDoubleArray from "../helpers/createRegexFromDoubleArray.js";
import getSentences from "../helpers/getSentences.js";
import { normalizeSingle as normalizeSingleQuotes } from "../helpers/quotes.js";
import { isWordInSentence as matchWordInSentence } from "../helpers/matchWordInSentence.js";
 ...
 * @param {Object} transitionWords The transition words.
 * @returns {object} An object with the total number of sentences in the text
 * and the total number of sentences containing one or more transition words.
 */
export default function( paper, transitionWords ) {
