...
import SentencePartGerman from "../../../../languages/de/config/passiveVoice/SentencePart.js";

import auxiliariesGermanFactory from "../../../../languages/de/config/passiveVoice/auxiliaries.js";

const auxiliariesGerman = auxiliariesGermanFactory().allAuxiliaries;
import stopwordsGermanFactory from "../../../../languages/de/config/passiveVoice/stopwords.js";
const stopwordsGerman = stopwordsGermanFactory();

// Dutch-specific imports.
import SentencePartDutch from "../../../../languages/nl/config/passiveVoice/SentencePart.js";

import stopwordsDutchFactory from "../../../../languages/nl/config/passiveVoice/stopwords.js";
const stopwordsDutch = stopwordsDutchFactory();
import auxiliariesDutchFactory from "../../../../languages/nl/config/passiveVoice/auxiliaries.js";
const auxiliariesDutch = auxiliariesDutchFactory();

// Polish-specific imports.
import SentencePartPolish from "../../../../languages/pl/config/passiveVoice/SentencePart.js";

import stopwordsPolishFactory from "../../../../languages/pl/config/passiveVoice/stopwords.js";
const stopwordsPolish = stopwordsPolishFactory();
import auxiliariesPolishFactory from "../../../../languages/pl/config/passiveVoice/auxiliaries.js";
