 ...
 */
export default class PPAttachmentAssessment extends Assessment {
	/**
	...
	getResult( paper, researcher ) {
		this.ambiguousSentences = researcher.getResearch( "checkPPAttachment" );
