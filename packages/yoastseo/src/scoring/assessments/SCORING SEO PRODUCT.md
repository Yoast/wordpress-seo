...
| Red   	      | 3		     | Keyphrase length > 8 words (> 9 for languages without function words support; > 7 for NL, DE, SV)	        | **Keyphrase length**: The keyphrase contains x (content) words. That's way more than the recommended maximum of 4 (content) words. **Make it shorter!**  |
| Red   	      | 3		     | Keyphrase length 1-2 words (1 word for NL, DE, SV)	                                                       | **Keyphrase length**: The keyphrase contains x (content) word(s). That's way less than the recommended minimum of x (content) words. **Make it longer!** |
| Orange   	      | 6	     | Keyphrase length between 7-8 words (7-9 for languages without function words support; 7 for NL, DE, SV)		 | **Keyphrase length**: The keyphrase contains x (content) words. That's more than the recommended maximum of 4 (content) words. **Make it shorter!**      |
| Orange   	      | 6	     | Keyphrase length 3 words (2 words for NL, DE, SV)		                                                       | **Keyphrase length**: The keyphrase contains x (content) words. That's less than the recommended minimum of x (content) words. **Make it longer!**       |
...
| Traffic light   	      | Score	     | Criterion                                                           | Feedback                                                                                                                                                                                                                                                               |
|------------	|------------------	|---------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Red	| -20	| Between 0 and 49 words (cornerstone: between 0 and 0)		             | **Text length**: The text contains X words. This is far below the recommended minimum of 200 (cornerstone: 400) words. **Add more content.**                                                                                                                           |
| Red	| -10 (cornerstone: -20)		| Between 50 and 99 words (cornerstone: between 0 and 199)		          | **Text length**: The text contains X words. This is far below the recommended minimum of 200 (cornerstone: 400) words. **Add more content.**                                                                                                                           |
| Red	| 3 (cornerstone: -20)		| Between 100 and and 149 words (cornerstone: between 200 and 299)			 | **Text length**: The text contains X words. This is below the recommended minimum of 200 (cornerstone: 400) words. **Add more content.**                                                                                                                               |
| Orange	| 6	| Between 150 and 199 words (cornerstone: between 300 and 399)		      | **Text length**: The text contains X words. This is slightly below the recommended minimum of 200 words. **Add a bit more copy.** (cornerstone: **Text length**: the text contains X words. This is below the recommended minimum of 400 words. **Add more content.**) |
| Green	| 9	| More than or exactly 200 words (cornerstone: 400)		                 | **Text length**: The text contains X words. Good job!                                                                                                                                                                                                                  |
