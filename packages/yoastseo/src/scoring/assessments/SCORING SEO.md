...
| Traffic light   	           | Score	               | Criterion                                                                                     | Feedback |
|-----------------------------|----------------------|-----------------------------------------------------------------------------------------------|---------------	|
| Red		                       | 3		                  | No images or no keyphrase set		                                                               | **Image Keyphrase**: This page does not have images, a keyphrase, or both. **Add some images with alt attributes that include the keyphrase or synonyms!** |
