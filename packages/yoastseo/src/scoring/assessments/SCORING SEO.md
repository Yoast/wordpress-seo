...
### 10) Image alt tags (only on product pages in Yoast WooCommerce SEO and Yoast SEO for Shopify)
...
### 11) Product identifier (only on product pages in Yoast WooCommerce SEO and Yoast SEO for Shopify)
...
### 12) SKU (only on product pages in Yoast WooCommerce SEO and Yoast SEO for Shopify)
