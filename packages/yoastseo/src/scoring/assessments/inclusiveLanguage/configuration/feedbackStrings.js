export const potentiallyHarmful = "Avoid using \"%1$s\" as it is potentially harmful. Consider using an alternative, such as \"%2$s\" instead.";
export const potentiallyHarmfulUnless = "Avoid using \"%1$s\" as it is potentially harmful. " +
	"Consider using an alternative, such as \"%2$s\" instead unless referring to yourself or to " +
