/*
 * The default first sentence of feedback strings for terms that receive a red bullet.
...
/*
 * The default first sentence of feedback strings for terms that receive an orange bullet.
 * This string is used unless there is a specific reason to use a different string.
 * %1$s is a string with the non-inclusive term.
 */
...
/*
 * The default second sentence of feedback strings for terms that receive a red bullet.
 * This string is used unless there is a specific reason to use a different string.
 * %2$s is a string with the alternative(s).
 */
export const alternative = "Consider using an alternative, such as %2$s.";
/*
 * The default second sentence of feedback strings for terms that receive an orange bullet that are used to describe people, and which some people may
 * use in reference to themselves. For example, 'Eskimo' or 'fat'. It is inclusive to use this term if someone wants to be referred to with it.
*/
...
/*
 * The default feedback string for terms that receive a red bullet.
...
/*
 * A string that's used to create some strings for terms that receive an orange bullet.
...
/*
 * The default feedback string for terms that receive an orange bullet that are used to describe people, and which some people may use
...
/*
* An additional string for offering alternatives for some terms that receive an orange bullet. It is used for terms like 'fat' or 'obese', for which
* there are many alternatives but also a lot of individual preferences in which term people want to be described with.
*/
