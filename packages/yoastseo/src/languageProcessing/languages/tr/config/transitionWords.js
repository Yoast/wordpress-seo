...
export const singleWords = [ "fakat", "halbuki", "hatta", "üstelik", "ancak", "oysa", "sonuçta", "yalnız", "çünkü", "oysaki", "kısacası", "özetle",
	...
	"birincisi", "i̇kincisi", "üçüncüsü", "sonuncusu", "tıpkı", "topyekun", "hem", "ne", "kah", "ister", "ya", "gerekse", "ha", "sayesinde", "sebebiyle",
...
export const multipleWords = [ "o halde", "bundan böyle", "demek ki", "ne yazık ki", "görüldüğü gibi", "i̇lk olarak", "son olarak", "ne var ki",
	...
	"bu niyetle", "hem de", "ne de", "ya da", "gerekse de", "aksi durumda", "bu durum", "olsun olmasın", "olup olmadığı", "diğer yandan",
	"öte yandan", "ne ne", "gerek gerek" ];
