...
const indefinitePronouns = ["هر کس", "هرکس",
	...
	"هر یک",
	"هیچ کدام", "هیچ‌کدام",
	"کمی", "خیلی", "دیگری", "همه", "بعضی", "هر دو", "معدود", "اندکی", "خیلی", "دیگران ", "چندین"];

const reciprocalNouns = ["همدیگر", "یکدیگر"];

const interrogatives = ["کی", "کِی", "کجا", "چه", "چرا", "چطور", "آیا"];

const quantifiers = ["کمی", "زیاد", "فراوان", "بیشتر", "بسیار", "کم کم", "مشتی", "تعداد بسیار کم", "مقدار بسیار کم",
	"تعداد زیادی", "مقدار زیادی", "بخش", "تعداد", "مقداری", "چند", "تمام", "خیلی زیاد"];
...
const prepositions = ["با", "باری", "نیز", "چندان که", "تا اینکه", "چون‌که", "اگرچه", "باوجوداین", "به شروطی که", "واسه‎ی",
	...
	"زیر", "کنار", "مانند", "مثل", "مقابل", "شبیه", "نزدیک", "میان", "پیش", "برخی", "پر", "زی", "سوای", "بهر", "به غیر ", "به غیر از"
	"به اضافه ی", "به اضافه", "به علاوه ی", "به وسیله ی", "به استثنای", "به مجرد", "به جهت", "به خاطر", "از نظر", "از روی", "ازسر",
	"از قبیل", "از لحاظ", "از حیث", "از جمله ی", "از جمله", "در برابر", "در مقابل", "درباره ی", "درباره", "درمورد", "درمیان", "درخصوص",
	"براثر", "براساس", "برطبق", "برحسب", "با وجود", "سوی", "از سر", "در مورد", "در میان", "در خصوص", "بر اثر", "بر اساس", "بر طبق",
];
...
const intensifiers = ["خیلی", "زیاد", "کاملا زیاد", "تقریباً", "تقریبا", "انصافاً", "انصافا", "به طرز حیرت انگیزی", "به طور عظیمی", "بیش ازحد",
	"بخصوص", "فوق العاده", "فوق‌العاده", "وحشتناک", "به طور شگفت آوری", "به طور شگفت‌آوری", "به معنای واقعی کلمه", "نسبتا",
	"واقعاً", "واقعا", "بسیار", "به طور فوق العاده", "به طور فوق‌العاده"];

const auxiliariesAndDelexicalizedVerbs = ["خواستن", "بایستن", "شایستن", "توانستن", "جرات کردن", "داشتن", "می‌شود",
...
const generalAdjectivesAdverbs = ["سیاه", "سفید", "آبی", "قهوه ایی", "خاکستری", "سبز", "نارنجی", "ارغوانی", "قرمز", "سفید",
	...
	"احتمال دارد", "امکان دارد", "تند", "کند", "آهسته", "سریع", "بد", "آسان", "ارزان", "نیک", "زشت ", "نالان", "دیروز", "باید"];
...
const titles = ["آقا", "آقای",
	"خانم", "دوشیزه", "جناب", "سرکار خانم",
	"سرکار آقا", "سرکار آقای",
	"دکتر",
	"جناب آقا", "جناب آقای"];
