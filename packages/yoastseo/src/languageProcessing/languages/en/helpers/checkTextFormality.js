...
function getPronouns( wordsArray, pronouns ) {
	return wordsArray.map( word => pronouns.includes( word ) );
}
 ...
 * @param {number} passiveSentences The number of occurrences of passive voice in the text.
 *
...
export default function( text, passiveSentences ) {
	 ...
	 * 4 = average number of formal pronouns
	...
	const averagePassives = passiveSentences / sentences.length;
