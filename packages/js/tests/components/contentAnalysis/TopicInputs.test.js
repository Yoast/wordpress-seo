...
import TopicInputsDefault, { TopicInputs } from "../../../src/components/contentAnalysis/TopicInputs";
...
describe( "TopicInputs", () => {
	...
	describe( "validation", () => {
		it( "shows the SEMrush 'no keyphrase' message when the keyphrase is empty and the flag is set", () => {
			render( <TopicInputs { ...props } displayNoKeyphraseMessage={ true } /> );
		...
		it( "shows the Wincher 'no keyphrase for tracking' message when the keyphrase is empty and the flag is set", () => {
			render( <TopicInputs { ...props } displayNoKeyphrasForTrackingMessage={ true } /> );
		...
		it( "shows the comma error when the keyphrase contains a comma", () => {
			render( <TopicInputs { ...props } keyword="yoast seo," /> );
		...
		it( "preserves errors that are passed in via the errors prop", () => {
			render( <TopicInputs { ...props } keyword="yoast seo" errors={ [ "Custom store error" ] } /> );
		...
		it( "renders multiple alerts when multiple validation rules trigger at once", () => {
			...
			render( <TopicInputs { ...props } keyword={ longKeywordWithComma } errors={ [ "Custom store error" ] } /> );
		...
		it( "treats a whitespace-only keyphrase as empty", () => {
			render( <TopicInputs { ...props } keyword="   " displayNoKeyphraseMessage={ true } /> );
	...
	describe( "collapsible selection", () => {
		it( "renders within the metabox collapsible when the location is metabox", () => {
			renderWithLocation( <TopicInputs { ...props } />, "metabox" );
		...
		it( "renders within the sidebar collapsible when the location is sidebar", () => {
			renderWithLocation( <TopicInputs { ...props } />, "sidebar" );
		...
		it( "renders with an unknown location by defaulting to the sidebar collapsible", () => {
			renderWithLocation( <TopicInputs { ...props } />, "custom-location" );
	...
	describe( "SEMrush integration", () => {
		it( "renders the SEMrush modal when the integration is active", () => {
			renderWithLocation(
				<TopicInputs { ...props } keyword="yoast seo" isSEMrushIntegrationActive={ true } />,
				"sidebar"
			);
		...
		it( "renders the SEMrush modal with the metabox location", () => {
			renderWithLocation(
				<TopicInputs { ...props } keyword="test" isSEMrushIntegrationActive={ true } />,
				"metabox"
			);
	...
	describe( "input attributes", () => {
		...
		it( "renders the input with the provided keyword value", () => {
			renderWithLocation( <TopicInputs { ...props } keyword="test keyword" />, "sidebar" );
...
describe( "TopicInputs default export", () => {
	beforeEach( () => {
