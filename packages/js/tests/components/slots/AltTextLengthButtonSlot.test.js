...
import { getAltTextLengthButtonSlotName } from "../../../src/analysis/constants";
import AltTextLengthButtonSlot from "../../../src/components/slots/AltTextLengthButtonSlot";
...
const renderSlotWithFills = ( location, fills ) => render(
	<SlotFillProvider>
		...
		<LocationProvider value={ location }>
			<AltTextLengthButtonSlot />
		</LocationProvider>
	</SlotFillProvider>
);

describe( "AltTextLengthButtonSlot", () => {
	...
	it( "ignores a fill meant for another location", () => {
		renderSlotWithFills(
			"metabox",
			<Fill name={ getAltTextLengthButtonSlotName( "sidebar" ) }>
				<button>Generate image alt text</button>
			</Fill>
		);
