...
describe( "SiteKitIntegration", () => {
	...
	it( "shows 'Set up Site Kit by Google' button when active but not set up", () => {
		render( <SiteKitIntegration isActive={ true } afterSetup={ false } isInstalled={ true } isConnected={ false } { ...urlsProps } /> );
	...
	it( "shows 'Connect Site Kit by Google' button when set up but not connected", () => {
		render( <SiteKitIntegration isActive={ true } afterSetup={ true } isInstalled={ true } isConnected={ false } { ...urlsProps } /> );
