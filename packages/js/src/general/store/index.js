...
import { noticesActions, noticesReducer, noticesSelectors, NOTICES_NAME, getInitialNoticesState } from "./notices";
	...
	return createReduxStore( STORE_NAME, {
		...
		initialState: merge(
			{},
			{
				...
				[ NOTICES_NAME ]: getInitialNoticesState(),
			},
			initialState
		),
