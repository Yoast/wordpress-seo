					...
					>
						<FormikFlippedToggleField
							...
							description={ <>
								{ sprintf(
								// translators: %1$s expands to the taxonomy plural, e.g. Categories.
									__( "Disabling this means that archive pages for %1$s will not be indexed by search engines and will be excluded from XML sitemaps. Read more about the search results settings.", "wordpress-seo" ),
									labelLower
								) }
								&nbsp;
