...
export const OrganicSessionsCompareWidget = ( { dataProvider, remoteDataProvider, dataFormatter } ) => {
	...
	return <Widget className="yst-paper__content yst-col-span-4">
		...
		{ data && Object.keys( data ).length > 0 &&
			<div className="yst-flex yst-flex-col yst-justify-center yst-items-center  @6xl:yst-flex-row @6xl:yst-justify-between rtl:yst-flex-row-reverse ">
				...
				/>
				<div className="yst-h-px yst-w-16 yst-bg-slate-200 yst-my-4 @6xl:yst-h-20 @6xl:yst-w-px @6xl:yst-my-1" />
				<OrganicSessionsCompareMetric
					metricName="Clicks"
					data={ data.clicks }
