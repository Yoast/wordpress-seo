 ...
 * @returns {JSX.Element} The CustomNotification component.
 */
...
CustomNotification.Description = Description;
CustomNotification.Content = Content;

Notifications.CustomNotification = CustomNotification;
Notifications.CustomNotification.displayName = "Notifications.CustomNotification";
