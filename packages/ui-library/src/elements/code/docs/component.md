A code-formatted block is a visual element used to display and format sections of text or code snippets in a way that differentiates them from regular text.
