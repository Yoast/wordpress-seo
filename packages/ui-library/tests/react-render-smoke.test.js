...
const cases = [
	...
	},
	{
		...
		props: { children: <SelectableList.Item onClick={ noop }>Row</SelectableList.Item> },
	},
	{
		name: "SelectableList.Item",
		Component: SelectableList.Item,
		props: { children: "Row", onClick: noop },
	},
