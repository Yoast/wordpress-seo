...
$generated_i18n_strings = array(
	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:18
	__( 'very easy', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:26
	__( 'easy', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:34
	__( 'fairly easy', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:42
	__( 'ok', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:50
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:67
	__( 'Try to make shorter sentences, using less difficult words to improve readability.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:66
	__( 'very difficult', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/fleschReadingEaseAssessment.js:85
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/paragraphTooLongAssessment.js:60
	__( 'None of the paragraphs are too long, which is great.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/paragraphTooLongAssessment.js:68
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/passiveVoiceAssessment.js:54
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/passiveVoiceAssessment.js:72
	/* Translators: %1$s expands to the number of sentences in passive voice, %2$s expands to a link on yoast.com,
	   %3$s expands to the anchor end tag, %4$s expands to the recommended value. */
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/sentenceBeginningsAssessment.js:56
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/sentenceLengthInDescriptionAssessment.js:45
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/sentenceLengthInDescriptionAssessment.js:56
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/sentenceLengthInTextAssessment.js:108
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/sentenceLengthInTextAssessment.js:117
	/* Translators: %1$d expands to percentage of sentences, %2$s expands to a link on yoast.com,
	   %3$s expands to the recommended maximum sentence length, %4$s expands to the anchor end tag,
	   %5$s expands to the recommended maximum percentage. */
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/subheadingDistributionTooLongAssessment.js:155
	__( 'The text does not contain any subheadings. Add at least one subheading.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/subheadingDistributionTooLongAssessment.js:163
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/textPresenceAssessment.js:18
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/transitionWordsAssessment.js:79
	/* Translators: %1$s expands to the number of sentences containing transition words, %2$s expands to a link on yoast.com,
	   %3$s expands to the anchor end tag. */
	__( '%1$s of the sentences contain a %2$stransition word%3$s or phrase, which is great.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/readability/wordComplexityAssessment.js:64
	...
	// Reference: node_modules/yoastseo/js/assessments/readability/wordComplexityAssessment.js:80
	/* Translators: %1$s expands to the percentage of complex words, %2$s expands to a link on yoast.com,
	   %3$d expands to the recommended maximum number of syllables,
	   %4$s expands to the anchor end tag, %5$s expands to the recommended maximum number of syllables. */
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/internalLinksAssessment.js:34
	__( 'This page has %1$s nofollowed internal link(s) and %2$s normal internal link(s).', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/internalLinksAssessment.js:44
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/keyphraseLengthAssessment.js:18
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/metaDescriptionLengthAssessment.js:96
	__( 'The meta description is under %1$d characters long. However, up to %2$d characters are available.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/metaDescriptionLengthAssessment.js:101
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/metaDescriptionLengthAssessment.js:106
	__( 'The length of the meta description is sufficient.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/outboundLinksAssessment.js:101
	__( 'No outbound links appear in this page, consider adding some as appropriate.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/outboundLinksAssessment.js:106
	/* Translators: %1$s expands the number of outbound links */
	__( 'This page has %1$s outbound link(s), all nofollowed.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/outboundLinksAssessment.js:114
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:77
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:96
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:105
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:121
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:137
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:153
	/* Translators: %1$d expands to the number of words in the text.
	   Translators: %1$d expands to the number of words in the text */
	_n_noop( 'The text contains %1$d word.', 'The text contains %1$d words.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:26
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:111
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:45
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:127
	/* Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words.
	   Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words */
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:64
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:83
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:143
	/* Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words.
	   Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words */
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/taxonomyTextLengthAssessment.js:102
	// Reference: node_modules/yoastseo/js/assessments/seo/textLengthAssessment.js:159
	/* Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words.
	   Translators: The preceding sentence is "The text contains x words.", %2$s expands to the recommended minimum of words */
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/textCompetingLinksAssessment.js:20
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/textImagesAssessment.js:112
	__( 'No images appear in this page, consider adding some as appropriate.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/textImagesAssessment.js:117
	__( 'The images on this page contain alt attributes with the focus keyword.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/textImagesAssessment.js:122
	__( 'The images on this page do not have alt attributes containing the focus keyword.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/textImagesAssessment.js:127
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/titleKeywordAssessment.js:23
	__( 'The SEO title contains the focus keyword, at the beginning which is considered to improve rankings.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/titleKeywordAssessment.js:29
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/urlKeywordAssessment.js:85
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/urlKeywordAssessment.js:89
	__( 'The focus keyword appears in the URL for this page.', 'wordpress-seo' ),

	// Reference: node_modules/yoastseo/js/assessments/seo/urlLengthAssessment.js:85
	...
	// Reference: node_modules/yoastseo/js/assessments/seo/urlStopWordsAssessment.js:46
