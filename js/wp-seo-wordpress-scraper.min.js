...
replaceVariablesPlugin = function( data ){
	if( typeof data !== "undefined" ){
		data = replaceVariablesTitleReplace( data );
		//data = replaceVariablesDefaultReplace( data );
		//data = replaceVariablesParentReplace( data );
		//data = replaceVariablesDoubleSepReplace( data );
		//data = replaceVariablesExcerptReplace( data );
	}
	return data;
}

replaceVariablesTitleReplace = function( data ){
	'use strict';
...
loadReplaceVariablePlugin = function() {
	if( typeof YoastSEO.app !== "undefined" ) {
		YoastSEO.app.plugins.register( "replaceVariablePlugin", {status: "ready"} );
		YoastSEO.app.plugins.registerModification( "replaceTextVariables", replaceVariablesPlugin, "replaceVariablePlugin", 10 );
	}else{
		setTimeout(loadReplaceVariablePlugin, 100);
	}
};
