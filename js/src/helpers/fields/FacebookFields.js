...
export default class FacebookFields {
	...
	static get titleElement() {
		return document.getElementById( "yoast_wpseo_opengraph-title" );
	}
	...
	static get descriptionElement() {
		return document.getElementById( "yoast_wpseo_opengraph-description" );
	}
	...
	static get imageIdElement() {
		return document.getElementById( "yoast_wpseo_opengraph-image-id" );
	}
	...
	static get imageUrlElement() {
		return document.getElementById( "yoast_wpseo_opengraph-image" );
	}
