...
export default class FacebookFields {
	...
	static get titleElement() {
		return document.getElementById( window.wpseoAdminL10n.isPostType ? "yoast_wpseo_opengraph-title" : "wpseo_opengraph-title" );
	}
	...
	static get descriptionElement() {
		return document.getElementById( window.wpseoAdminL10n.isPostType ? "yoast_wpseo_opengraph-description" : "wpseo_opengraph-description" );
	}
	...
	static get imageIdElement() {
		return document.getElementById( window.wpseoAdminL10n.isPostType ? "yoast_wpseo_opengraph-image-id" : "hidden_wpseo_opengraph-image-id" );
	}
	...
	static get imageUrlElement() {
		return document.getElementById( window.wpseoAdminL10n.isPostType ? "yoast_wpseo_opengraph-image" : "wpseo_opengraph-image" );
	}
