 ...
 *
 * @param {AnalysisWorkerWrapper} worker      The analysis worker to request the
 *                                            analysis from.
 * @param {Function}              collectData Function that collects the
 *                                            analysis data.
 * @param {Function}              applyMarks  Function that applies the marks in
 *                                            the content.
 * @param {Object}                store       The store.
 *
 * @returns {void}
 */
export default function refreshAnalysis( worker, collectData, applyMarks, store ) {
