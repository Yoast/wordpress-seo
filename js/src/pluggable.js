 ...
 */
var Pluggable = function( app ) { // todo: possibly needs to take refresh as a parameter
	this.app = app;
	this.loaded = false;
...
Pluggable.prototype._reloaded = function( pluginName ) {
	...
	this.app.refresh(); // todo: call non-app refresh
	return true;
};
...
Pluggable.prototype._pollTimeExceeded = function() {
	...
	this.loaded = true;
	this.app.pluginsLoaded(); // todo: call non-app refresh
};
