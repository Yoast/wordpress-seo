!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){/* global wpseoAdminL10n, ajaxurl, setWPOption, tb_remove, YoastSEO, wpseoSelect2Locale */
/* jshint -W097 */
/* jshint -W003 */
/* jshint unused:false */
!function(){"use strict";/**
...
jQuery(window).on("hashchange",e),/**
	 * When the hash changes, get the base url from the action and then add the current hash
	 */
jQuery(document).on("ready",e),window.wpseoDetectWrongVariables=a,window.setWPOption=b,window.wpseoKillBlockingFiles=c,window.wpseoCopyHomeMeta=d,window.wpseo_add_fb_admin=f,window.wpseoSetTabHash=e,jQuery(document).ready(function(){/* Fix banner images overlapping help texts */
...
// init
var b=window.location.hash.replace("#top#","");
// default to first tab
""!==b&&"#_=_"!==b||(b=jQuery(".wpseotab").attr("id")),jQuery("#"+b).addClass("active"),jQuery("#"+b+"-tab").addClass("nav-tab-active"),jQuery(".nav-tab-active").click(),g()})}()},{}]},{},[1]);