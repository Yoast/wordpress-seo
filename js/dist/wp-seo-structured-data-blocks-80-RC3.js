...
var _block = __webpack_require__(1656);
...
var _HowTo = __webpack_require__(1657);
...
exports.default = function () {
   ...
   */
		save: function save(_ref2) {
			...
			return _HowTo2.default.getContent(attributes);
		}
	});
};
...
var _HowToStep = __webpack_require__(1658);

var _HowToStep2 = _interopRequireDefault(_HowToStep);

var _stringHelpers = __webpack_require__(1030);
  ...
  */
   ...
   */
		...
		value: function getContent(attributes) {
			...
			var classNames = ["schema-how-to", className].filter(function (i) {
				return i;
			}).join(" ");
			var listClassNames = ["schema-how-to-steps", additionalListCssClasses].filter(function (i) {
				return i;
			}).join(" ");
