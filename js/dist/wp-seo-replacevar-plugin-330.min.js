...
g.prototype.addScope=function(a){this.hasScope()||(this.options.scope=[]),this.options.scope.push(a)},/**
	 ...
	 */
g.prototype.inScope=function(a){return this.hasScope()?d(this.options.scope,a)>-1:!0},/**
...
i.prototype.getAvailableTaxonomies=function(a){var b=jQuery(a).find("input[type=checkbox]"),c=jQuery(a).attr("id").replace("taxonomy-","");b.length>0&&this.parseTaxonomies(b,c),this.declareReloaded()},/**
	 ...
	 */
i.prototype.bindTaxonomyEvents=function(a,b){b=jQuery(b),b.on("wpListAddEnd",".categorychecklist",this.getAvailableTaxonomies.bind(this,b)),b.on("change","input[type=checkbox]",this.getAvailableTaxonomies.bind(this,b)),this.getAvailableTaxonomies(b)},/**
 ...
 */
function d(a,b){b=f(b,a)?[b]:e(b);for(var c=0,d=b.length;null!=a&&d>c;)a=a[g(b[c++])];return c&&c==d?a:void 0}var e=a("./_castPath"),f=a("./_isKey"),g=a("./_toKey");b.exports=d},{"./_castPath":44,"./_isKey":72,"./_toKey":101}],28:[function(a,b,c){/**
 ...
 */
function d(a,b,c,h,i){return a===b?!0:null==a||null==b||!f(a)&&!g(b)?a!==a&&b!==b:e(a,b,d,c,h,i)}var e=a("./_baseIsEqualDeep"),f=a("./isObject"),g=a("./isObjectLike");b.exports=d},{"./_baseIsEqualDeep":32,"./isObject":120,"./isObjectLike":121}],32:[function(a,b,c){/**
...
if(q){if(!f(b,function(a,b){return q.has(b)||r!==a&&!c(r,a,d,i,j)?void 0:q.add(b)})){p=!1;break}}else if(r!==s&&!c(r,s,d,i,j)){p=!1;break}}return j["delete"](a),p}var e=a("./_SetCache"),f=a("./_arraySome"),g=1,h=2;b.exports=d},{"./_SetCache":11,"./_arraySome":19}],52:[function(a,b,c){/**
 ...
 *  else `false`.
 */
function d(a,b,c){if(!h(c))return!1;var d=typeof b;return("number"==d?f(c)&&g(b,c.length):"string"==d&&b in c)?e(c[b],a):!1}var e=a("./eq"),f=a("./isArrayLike"),g=a("./_isIndex"),h=a("./isObject");b.exports=d},{"./_isIndex":70,"./eq":105,"./isArrayLike":114,"./isObject":120}],72:[function(a,b,c){/**
 ...
 */
function d(a,b){if(e(a))return!1;var c=typeof a;return"number"==c||"symbol"==c||"boolean"==c||null==a||f(a)?!0:h.test(a)||!g.test(a)||null!=b&&a in Object(b)}var e=a("./isArray"),f=a("./isSymbol"),g=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,h=/^\w*$/;b.exports=d},{"./isArray":113,"./isSymbol":123}],73:[function(a,b,c){/**
 ...
 * @returns {boolean} Returns `true` if the entry was removed, else `false`.
 */
function d(a){var b=this.__data__,c=e(b,a);if(0>c)return!1;var d=b.length-1;return c==d?b.pop():g.call(b,c,1),!0}var e=a("./_assocIndexOf"),f=Array.prototype,g=f.splice;b.exports=d},{"./_assocIndexOf":22}],80:[function(a,b,c){/**
 ...
 * @returns {*} Returns the entry value.
 */
function d(a){var b=this.__data__,c=e(b,a);return 0>c?void 0:b[c][1]}var e=a("./_assocIndexOf");b.exports=d},{"./_assocIndexOf":22}],81:[function(a,b,c){/**
 ...
 */
function d(a,b){var c=this.__data__,d=e(c,a);return 0>d?c.push([a,b]):c[d][1]=b,this}var e=a("./_assocIndexOf");b.exports=d},{"./_assocIndexOf":22}],83:[function(a,b,c){/**
 ...
 * // => 3
 */
function d(a,b,c){var d=a?a.length:0;if(!d)return-1;var h=null==c?0:f(c);return 0>h&&(h=g(d+h,0)),e(a,b,h)}var e=a("./_baseIndexOf"),f=a("./toInteger"),g=Math.max;b.exports=d},{"./_baseIndexOf":30,"./toInteger":133}],112:[function(a,b,c){/**
 ...
 * // => 3.2
 */
function d(a){if(!a)return 0===a?a:0;if(a=e(a),a===f||a===-f){var b=0>a?-1:1;return b*g}return a===a?a:0}var e=a("./toNumber"),f=1/0,g=1.7976931348623157e308;b.exports=d},{"./toNumber":134}],133:[function(a,b,c){/**
