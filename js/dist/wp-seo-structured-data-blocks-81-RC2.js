...
var _block = __webpack_require__(1935);

var _block2 = _interopRequireDefault(_block);

var _block3 = __webpack_require__(1939);
...
var _HowTo = __webpack_require__(1936);
...
var _HowToStep = __webpack_require__(1937);

var _HowToStep2 = _interopRequireDefault(_HowToStep);

var _isUndefined = __webpack_require__(62);
...
var _stringHelpers = __webpack_require__(1088);
...
var HowTo = function (_Component) {
  ...
  */
   ...
   * @returns {void}
   */
		value: function changeStep(newContents, prevContents, index) {
			...
			steps[index].jsonContents = (0, _stringHelpers.stripHTML)(renderToString(newContents));

			var imageSrc = _HowToStep2.default.getImageSrc(newContents);
   ...
   */
		...
		value: function insertStep(index) {
			...
			steps.splice(index + 1, 0, {
				...
				contents: contents,
				jsonContents: (0, _stringHelpers.stripHTML)(renderToString(contents))
			});
			...
			return this.props.attributes.steps.map(function (step, index) {
				return yoast._wp.element.createElement(_HowToStep2.default, {
					...
					onChange: function onChange(newStepContents) {
						return _this2.changeStep(newStepContents, step.contents, index);
					},
			...
			return yoast._wp.element.createElement(
				...
				yoast._wp.element.createElement("input", {
					...
					onChange: function onChange(event) {
						return setAttributes({ hours: Math.max(0, event.target.value) });
					},
					placeholder: "HH" }),
				yoast._wp.element.createElement(
					"span",
				...
				yoast._wp.element.createElement("input", {
					...
					onChange: function onChange(event) {
						return setAttributes({ minutes: Math.min(Math.max(0, event.target.value), 60) });
					},
					placeholder: "MM" }),
			...
			return yoast._wp.element.createElement(
				...
				yoast._wp.element.createElement(
					...
					yoast._wp.element.createElement(TextControl, {
						label: (0, _i18n.__)("Additional CSS Classes for list", "wordpress-seo"),
						value: additionalClasses,
						onChange: this.addCSSClasses,
						help: (0, _i18n.__)("CSS classes to add to the list of steps (excluding the how-to header)", "wordpress-seo")
					}),
   ...
   */
		...
		value: function Content(props) {
			...
			var timeString = [hours && _moment2.default.duration(hours, "hours").humanize(), minutes && _moment2.default.duration(minutes, "minutes").humanize()].filter(function (item) {
				return item;
			}).join(" and ");
			...
			return yoast._wp.element.createElement(
				...
				hasDuration && yoast._wp.element.createElement(
					"p",
			...
			return yoast._wp.element.createElement(
				...
				yoast._wp.element.createElement(RichText, {
					...
					onChange: function onChange(value) {
						return _onChange(value, contents);
					},
...
var _FAQ = __webpack_require__(1940);
...
var _Question = __webpack_require__(1941);
   ...
   */
		...
		value: function swapQuestions(index1, index2) {
			...
			var _state$focus$split = this.state.focus.split(":"),
			    ...
			    focusPart = _state$focus$split2[1];
   ...
   */
		...
		value: function getQuestions() {
			...
			var _state$focus$split3 = this.state.focus.split(":"),
			    ...
			    focusPart = _state$focus$split4[1];
...
Question.propTypes = {
	...
	onMoveUp: _propTypes2.default.func.isRequired,
	onMoveDown: _propTypes2.default.func.isRequired,
	focusPart: _propTypes2.default.string,
...
var emptyFunction = __webpack_require__(1050);
var invariant = __webpack_require__(1062);
