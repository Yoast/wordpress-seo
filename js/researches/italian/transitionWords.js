...
let singleWords = [ "abbastanza", "acciocché", "acciocchè", "adesso", "affinché", "affinchè", "allora", "almeno", "alquanto", "altrettanto",
	...
	"contrariamente", "controbilanciato", "così", "cosicché", "cosicchè", "da", "dapprima", "dato", "davvero", "definitivamente",
	"degli", "del", "della", "delle", "dettagliatamente", "di", "differente", "differentemente", "diversamente",
	"diverso", "dopo", "dopodiché", "dopodichè", "durante", "dunque", "eccetto", "eccome", "effettivamente", "egualmente",
	"elencando", "enfaticamente", "eppure", "esaurientemente", "esplicitamente", "espressamente", "estesamente",
	"evidentemente", "finalmente", "finché", "finchè", "fino", "finora", "fintanto", "fintanto che", "fintantoché", "fintantochè",
	...
	"memorabile", "mentre", "molto", "motivatamente", "naturalmente", "né", "nè", "neanche", "neppure", "nonché", "nonchè", "nondimeno",
	"nonostante", "notevolmente", "occasionalmente", "oltretutto", "onde", "onestamente", "ora", "ossia", "ostinatamente",
	"ovvero", "ovviamente", "parimenti", "particolarmente", "per", "peraltro", "perché", "perchè", "perciò", "perlomeno", "però",
	...
	"prossimo", "pure", "purché", "purchè", "quando", "quanto", "quantomeno", "quarto", "quindi", "raramente", "realmente", "relativamente",
