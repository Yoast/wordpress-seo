...
let otherAuxiliaries = [ "haber", "he", "has", "ha", "hay", "hemos", "habéis", "han", "hube", "hubiste", "hubo", "hubimos", "hubisteis",
	...
	"habed", "habido", "deber", "debo", "debes", "debe", "debemos", "debéis", "deben", "debí", "debiste", "debió", "debimos", "debisteis",
	...
	"debieren", "debed", "debido", "empezar", "empiezo", "empiezas", "empieza", "empezáis", "empiezan", "empecé", "empezaste", "empezó",
	...
	"empezad", "empezado", "comenzar", "comienzo", "comienzas", "comienza", "comenzamos", "comenzáis", "comienzan", "comencé", "comenzaste",
	...
	"comenzareis", "comenzaren", "comenzad", "comenzado", "seguir", "sigo", "sigues", "sigue", "seguimos", "seguis", "siguen", "seguí",
	...
	"seguid", "seguido", "tener", "tengo", "tienes", "tiene", "tenemos", "tenéis", "tienen", "tuve", "tuviste", "tuvo", "tuvimos", "tuvisteis",
	...
	"tuviéremos", "tuviereis", "tuvieren", "ten", "tened", "tenido", "andar", "ando", "andas", "andamos", "andáis", "andan", "anduve", "anduviste",
	...
	"anduvieseis", "anduviesen", "anduviere", "anduvieres", "anduviéremos", "anduviereis", "anduvieren", "andad", "andado", "quedar", "quedo",
	...
	"hallar", "hallo", "hallas", "halla", "hallamos", "halláis", "hallan", "hallé", "hallaste", "halló", "hallasteis", "hallaron", "hallaba",
	...
	"hallaren",	"hallad", "hallado", "venir", "vengo", "vienes", "viene", "venimos", "venis", "vienen", "vine", "viniste", "vino", "vinimos",
	...
	"viniereis", "vinieren", "ven", "venid", "venido", "abrir", "abro", "abres", "abre", "abrismos", "abrís", "abren", "abrí", "abriste", "abrió",
	...
	"abrieren", "abrid", "abierto", "ir", "voy", "vas", "va", "vamos", "vais", "van", "fui", "fuiste", "fue", "fuimos", "fuisteis", "fueron", "iba",
	...
	"fuere", "fueres", "fuéremos", "fuereis", "fueren", "ve", "id", "ido", "acabar", "acabo", "acabas", "acaba", "acabamos", "acabáis", "acaban",
	...
	"acabaseis", "acabasen", "acabare", "acabares", "acabáremos", "acabareis", "acabaren", "acabad", "acabado", "llevar", "llevo", "llevas", "lleva",
	...
	"llevado", "alcanzar", "alcanzo", "alcanzas", "alcanza", "alcanzamos", "alcanzáis", "alcanzan", "alcancé", "alcanzaste", "alcanzó",
	...
	"alcanzaren", "alcanzad", "alcanzado", "decir", "digo", "dices", "dice", "decimos", "decís", "dicen", "dije", "dijiste", "dijo", "dijimos",
	...
	"dicho", "continuar", "continúo", "continúas", "continúa", "continuamos", "continuáis", "continúan", "continué", "continuaste",
	...
	"continuares", "continuáremos", "continuareis", "continuaren", "continuad", "continuado", "resultar", "resulto", "resultas", "resulta",
	...
	"puede", "podemos", "podéis", "pueden", "pude", "pudiste", "pudo", "pudimos", "pudisteis", "pudieron", "poder", "podía", "podías", "podíamos",
	...
	"pudiésemos", "pudieseis", "pudiesen", "pudiere", "pudieres", "pudiéremos", "pudiereis", "pudieren", "poded", "podido", "querer", "quiero",
	...
	"quisiereis", "quisieren", "quered", "querido", "saber", "sé", "sabes", "sabe", "sabemos", "sabéis", "saben", "supe", "supiste", "supo",
	...
	"supiereis", "supieren", "sabed", "sabido", "soler", "suelo", "sueles", "suele", "solemos", "soléis", "suelen", "solí", "soliste", "solió",
	...
	"soliéremos", "soliereis", "solieren", "soled", "solido", "necesitar", "necesito", "necesitas", "necesitamos", "necesitáis", "necesitan",
...
module.exports = function() {
	return {
		...
		verbs: otherAuxiliaries.concat( copula, interviewVerbs, delexicalisedVerbs ),
		...
		all: articles.concat( numerals, demonstrativePronouns, possessivePronouns, reflexivePronouns, personalPronounsNominative,
			...
			interrogativeProAdverbs, locativeAdverbs, prepositionalAdverbs, otherAuxiliaries, copula, prepositions,
