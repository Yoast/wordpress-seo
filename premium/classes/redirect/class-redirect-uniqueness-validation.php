 ...
 *
 * This validation will check if the redirect that will be created/updated already exists as a redirect.
 */
class WPSEO_Redirect_Uniqueness_Validation implements WPSEO_Redirect_Validation {
	...
	/**
	 * Validate the redirect to check if the origin already exists as a redirect.
	 *
