var FrenchSentencePart = require( "../../../../js/researches/french/SentencePart.js");
...
describe( "creates a French sentence part", function() {
	...
	it ( "returns a irregular participle for an French sentence part", function() {
	...
	it ( "returns a irregular participle with a suffix for an French sentence part", function() {
	...
	it ( "returns a regular participle with a suffix for an French sentence part", function() {
