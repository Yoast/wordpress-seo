...
const keywordStopWordsAssessment = require( "../../src/assessments/seo/keywordStopWordsAssessment" );
import MetaDescriptionKeywordAssessment from "../../src/assessments/seo/MetaDescriptionKeywordAssessment";
const MetaDescriptionLengthAssessment = require( "../../src/assessments/seo/metaDescriptionLengthAssessment" );
const SubheadingsKeywordAssessment = require( "../../src/assessments/seo/subheadingsKeywordAssessment" );
import TextCompetingLinksAssessment from "../../src/assessments/seo/TextCompetingLinksAssessment";
const TextImagesAssessment = require( "../../src/assessments/seo/textImagesAssessment" );
const TextLengthAssessment = require( "../../src/assessments/seo/textLengthAssessment" );
const OutboundLinksAssessment = require( "../../src/assessments/seo/outboundLinksAssessment" );
...
const TitleWidthAssessment = require( "../../src/assessments/seo/pageTitleWidthAssessment" );
import UrlKeywordAssessment from "../../src/assessments/seo/UrlKeywordAssessment";
const UrlLengthAssessment = require( "../../src/assessments/seo/urlLengthAssessment" );
const urlStopWordsAssessment = require( "../../src/assessments/seo/urlStopWordsAssessment" );
...
const FleschReadingAssessment = require( "../../src/assessments/readability/fleschReadingEaseAssessment" );
const SubheadingDistributionTooLongAssessment = require( "../../src/assessments/readability/subheadingDistributionTooLongAssessment" );
const paragraphTooLongAssessment = require( "../../src/assessments/readability/paragraphTooLongAssessment" );
const SentenceLengthInTextAssessment = require( "../../src/assessments/readability/sentenceLengthInTextAssessment" );
const transitionWordsAssessment = require( "../../src/assessments/readability/transitionWordsAssessment" );
const passiveVoiceAssessment = require( "../../src/assessments/readability/passiveVoiceAssessment" );
const textPresenceAssessment = require( "../../src/assessments/readability/textPresenceAssessment" );
const sentenceBeginningsAssessment = require( "../../src/assessments/readability/sentenceBeginningsAssessment" );


// Import researches
const findKeywordInFirstParagraph = require( "../../src/researches/findKeywordInFirstParagraph.js" );
...
const metaDescriptionKeyword = require( "../../src/researches/metaDescriptionKeyword.js" );
const metaDescriptionLength = require( "../../src/researches/metaDescriptionLength.js" );
const matchKeywordInSubheadings = require( "../../src/researches/matchKeywordInSubheadings.js" );
const getLinkStatistics = require( "../../src/researches/getLinkStatistics.js" );
const imageCount = require( "../../src/researches/imageCountInText.js" );
const altTagCount = require( "../../src/researches/imageAltTags.js" );
const wordCountInText = require( "../../src/researches/wordCountInText.js" );
const findKeywordInPageTitle = require( "../../src/researches/findKeywordInPageTitle.js" );
const pageTitleWidth = require( "../../src/researches/pageTitleWidth.js" );
const keywordCountInUrl = require( "../../src/researches/keywordCountInUrl" );
const urlLength = require( "../../src/researches/urlIsTooLong.js" );
const stopWordsInUrl = require( "../../src/researches/stopWordsInUrl" );
const largestKeywordDistance = require( "../../src/researches/largestKeywordDistance" );
const calculateFleschReading = require( "../../src/researches/calculateFleschReading.js" );
const getSubheadingTextLengths = require( "../../src/researches/getSubheadingTextLengths.js" );
const getParagraphLength = require( "../../src/researches/getParagraphLength.js" );
const countSentencesFromText = require( "../../src/researches/countSentencesFromText.js" );
const findTransitionWords = require( "../../src/researches/findTransitionWords.js" );
const passiveVoice = require( "../../src/researches/getPassiveVoice.js" );
const getSentenceBeginnings = require( "../../src/researches/getSentenceBeginnings.js" );
