...
describe("Test for the syllablecount", function(){
    ...
    YoastSEO.analyzerConfig.preprocessorConfig.syllables.exclusionWords.push({word: "exclusionwords", syllables: 5});
    YoastSEO.analyzerConfig.preprocessorConfig.syllables.exclusionWords.push({word: "syllablecount", syllables: 4});
