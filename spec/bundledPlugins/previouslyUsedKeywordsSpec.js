...
describe( "checks for keyword doubles", function(){
	it("returns array with keyword", function(){
		...
		expect( plugin.scoreAssessment( {id: 1, count: 1}, paper, i18n ).text ).toBe( "You've used this focus keyword <a href='http://post?1'>once before</a>, " +
		...
		expect( plugin.scoreAssessment({id: 1, count: 2 }, paper, i18n ).text ).toBe( "You've used this focus keyword <a href='http://search?keyword'>2 times before</a>, it's probably a good idea to read <a href='https://yoast.com/cornerstone-content-rank/' target='new'>this post on cornerstone content</a> and improve your keyword strategy." );
