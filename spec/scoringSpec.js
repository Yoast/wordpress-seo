...
describe("a test for the scoring function of all functions in the analyzer", function(){
   it("returns scores for all objects", function(){
       ...
       expect(analyzeScore[6].text).toBe("The keyword for this page contains one or more <a href='https://en.wikipedia.org/wiki/Stop_words'>stop words</a>, consider removing them. Found 'about'.");
