...
describe( "An assessor running the linkStatistics", function(){
	it( "Accepts a paper and i18nobject  ", function(){
		...
		var assessment = linkStatisticAssessment( mockPaper, Factory.buildMockResearcher( mockResult ), i18n );
		...
		assessment = linkStatisticAssessment( mockPaper, Factory.buildMockResearcher( mockResult ), i18n );
