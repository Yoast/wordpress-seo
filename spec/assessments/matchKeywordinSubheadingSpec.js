...
describe( "An assessment for matching keywords in subheadings", function(){
	it( "assesses a string without subheadings", function(){
		...
		var assessment = matchKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( { count: 0 } ), i18n );
	...
	it( "assesses a string with subheadings without keywords", function(){
		var mockPaper = new Paper();
		var assessment = matchKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( { count: 1, matches: 0 } ), i18n );
	...
	it( "assesses a string with subheadings and keywords", function(){
		var mockPaper = new Paper();
		var assessment = matchKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( { count: 1, matches: 1 } ), i18n );
	...
	it( "assesses a string with subheadings and keywords", function(){
		var mockPaper = new Paper();
		var assessment = matchKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( { count: 10, matches: 1 } ), i18n );
