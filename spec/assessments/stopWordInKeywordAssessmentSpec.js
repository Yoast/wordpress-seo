var stopWordsInKeywordAssessment = require( "../../js/assessments/stopWordsInKeyword.js" );
...
describe( "A stop word in keyword assessment", function() {
	it( "assesses no stop words in the keyword", function() {
		...
		var assessment = stopWordsInKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( [] ), i18n );
	...
	it( "assesses one stop word in the keyword", function() {
		...
		var assessment = stopWordsInKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( [ "about" ] ), i18n );
		expect( assessment.getScore() ).toEqual( 0 );
		expect( assessment.hasScore() ).toEqual( false );
	...
	it( "assesses multiple stop words in the keyword", function(){
		...
		var assessment = stopWordsInKeywordAssessment.callback( mockPaper, Factory.buildMockResearcher( [ "about", "before" ] ), i18n );
		expect( assessment.getScore() ).toEqual( 0 );
