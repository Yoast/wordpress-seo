...
describe( "An assessment for scoring too short paragraphs.", function() {
	...
	it( "scores 1 slightly too short paragraph", function() {
		...
		expect( assessment.getText() ).toBe( "1 of the paragraphs contains less than the recommended minimum. The recommended minimum is" +
	...
	it( "scores 3 paragraphs, one of which is too short", function() {
		...
		expect( assessment.getText() ).toBe( "1 of the paragraphs contains less than the recommended minimum. The recommended minimum" +
	...
	it( "scores 3 paragraphs, two of which are too short", function() {
		...
		expect( assessment.getText() ).toBe( "2 of the paragraphs contain less than the recommended minimum. The recommended minimum is 40 words. Try to expand" +
