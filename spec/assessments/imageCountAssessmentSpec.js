var imageCountAssessment = require( "../../js/assessments/imageCount" );
...
describe( "An image count assessment", function() {
	it( "assesses no images", function(){
		...
		var assessment = imageCountAssessment.callback( mockPaper, Factory.buildMockResearcher( 0 ), i18n );
	...
	it( "assesses a single image, without a keyword and alt-tag set", function() {
		...
		var assessment = imageCountAssessment.callback( mockPaper, Factory.buildMockResearcher( {
			noAlt: 1,
			withAlt: 0,
			withAltKeyword: 0,
			withAltNonKeyword: 0
