...
describe( "A keyword in url count assessment", function(){
	it( "assesses no keyword was found in the url", function() {
		...
		var assessment = keywordInUrl.callback( mockPaper, Factory.buildMockResearcher( 0 ), i18n );
	...
	it( "assesses a keyword was found in the url", function() {
		...
		var assessment = keywordInUrl.callback( mockPaper, Factory.buildMockResearcher( 1 ), i18n );
