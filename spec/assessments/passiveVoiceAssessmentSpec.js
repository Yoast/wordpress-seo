...
describe( "An assessment for scoring passive voice.", function() {
	...
	it( "scores 2 passive sentences - 10%", function() {
		var assessment = passiveVoiceAssessment.getResult( paper, Factory.buildMockResearcher( {total: 20, passives: 2 } ), i18n );
	...
	it( "scores 10 passive sentence - 50%", function() {
		var assessment = passiveVoiceAssessment.getResult( paper, Factory.buildMockResearcher( {total: 20, passives: 10 } ), i18n );
	...
	it( "scores 5 passive sentences - 25%", function() {
		var assessment = passiveVoiceAssessment.getResult( paper, Factory.buildMockResearcher( {total: 20, passives: 5 } ), i18n );
		expect( assessment.getScore() ).toBe( 3 );
	...
	it( "scores 5 passive sentences - 33%", function() {
		var assessment = passiveVoiceAssessment.getResult( paper, Factory.buildMockResearcher( {total: 30, passives: 4 } ), i18n );
