...
describe( "An assessment for scoring passive voice.", function() {
	...
	it( "scores 10 passive sentence - 50%", function() {
		...
		expect( assessment.getText() ).toBe( "50% of the sentences contain a passive voice, which is more than the recommended maximum of 10%. " +
	...
	it( "scores 5 passive sentences - 25%", function() {
		...
		expect( assessment.getScore() ).toBe( 3 );
		expect( assessment.getText() ).toBe( "25% of the sentences contain a passive voice, which is more than the recommended maximum of 10%. " +
			"Try to use their active counterparts." );
		expect( assessment.hasMarks() ).toBe( true );
	} );
