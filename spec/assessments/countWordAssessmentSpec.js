...
describe( "A word count assessment", function(){
	it( "assesses a single word", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 1 ), i18n );
	...
	it( "assesses a low word count", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 5 ), i18n );
	...
	it( "assesses a medium word count", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 150 ), i18n );
	...
	it( "assesses a slightly higher than medium word count", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 225 ), i18n );
	...
	it( "assesses an almost at the recommended amount, word count", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 275 ), i18n );
	...
	it( "assesses high word count", function(){
		...
		var assessment = wordCountAssessment( mockPaper, Factory.buildMockResearcher( 325 ), i18n );
