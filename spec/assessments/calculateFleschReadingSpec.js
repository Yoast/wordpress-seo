...
describe( "An assessment for the fleschReading", function(){
	it( "runs the fleschReading on the paper", function(){
		...
		var result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 63.9 ), i18n );
		...
		result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 78.9 ), i18n );
		...
		result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 36.6 ), i18n );
		...
		result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 0 ), i18n );
		...
		result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 60.0 ), i18n );
		expect( result.getScore() ).toBe( 8 );
		...
		result = fleschReadingAssessment.callback( paper, Factory.buildMockResearcher( 100.0 ), i18n );
		expect( result.getScore() ).toBe( 9 );
		expect( result.getText() ).toBe( "The copy scores 100 in the <a href='https://yoast.com/flesch-reading-ease-score/' target='new'>Flesch Reading Ease</a> test, which is considered very easy to read. " );
