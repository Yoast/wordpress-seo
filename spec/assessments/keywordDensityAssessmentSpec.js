...
describe( "An assessment for the keywordDensity", function(){
	it( "runs the keywordDensity on the paper", function(){
		...
		var result = keywordDensityAssessment.callback( paper, Factory.buildMockResearcher( 0 ), i18n );
		...
		result = keywordDensityAssessment.callback( paper, Factory.buildMockResearcher( 10 ), i18n );
		...
		paper = new Paper( "string with the keyword", {keyword: "keyword"} );
		result = keywordDensityAssessment.callback( paper, Factory.buildMockResearcher( 2 ), i18n );
		...
		result = keywordDensityAssessment.callback( paper, Factory.buildMockResearcher( 3 ), i18n );
