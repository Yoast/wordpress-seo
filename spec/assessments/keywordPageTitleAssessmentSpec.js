...
describe( "an assessment to check if the keyword is in the pageTitle", function(){
	it( "returns an assementresult with keyword not found", function(){
		...
		var assessment = pageTitleKeywordAssessment.callback( paper, Factory.buildMockResearcher( {matches: 0} ), i18n );
	...
	it( "returns an assementresult with keyword found at start", function(){
		...
		var assessment = pageTitleKeywordAssessment.callback( paper, Factory.buildMockResearcher( {matches: 1, position: 0 } ), i18n );
	...
	it( "returns an assementresult with keyword found at start", function(){
		...
		var assessment = pageTitleKeywordAssessment.callback( paper, Factory.buildMockResearcher( {matches: 1, position: 2} ), i18n );
