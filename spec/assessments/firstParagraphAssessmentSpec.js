...
describe( "An assessment for finding the keyword in the first paragraph", function() {
	it( "returns a keyword found in the first paragraph", function() {
		var assessment = firstParagraphAssessment.callback( paper, Factory.buildMockResearcher( 1 ), i18n );
	...
	it( "returns multiple keywords found in the first paragraph", function() {
		var assessment = firstParagraphAssessment.callback( paper, Factory.buildMockResearcher( 10 ), i18n );
	...
	it( "returns no keyword found in the first paragraph", function() {
		var assessment = firstParagraphAssessment.callback( paper, Factory.buildMockResearcher( 0 ), i18n );
