...
describe( "An assessment for scoring too long sub texts.", function() {
	it( "scores 3 subheading texts, 0 are too long", function() {
		...
		expect( assessment.getText() ).toBe( "The number of words following each of the subheadings exceeds the recommended minimum of 40 words, which is great." );
	} );
	...
	it ( "returns a heading that is too short", function() {
		...
		expect( assessment.getText() ).toBe( "The number of words following 1 of the subheadings is too small. The recommended minimum is 40 words. Consider deleting that particular subheading, or the following subheading." );
	} );
	...
	it ( "returns 3 headings that are too short", function() {
		...
		expect( assessment.getScore() ).toBe( 3 );
		expect( assessment.getText() ).toBe( "The number of words following 3 of the subheadings is too small. The recommended minimum is 40 words. Consider deleting those particular subheadings, or the subheading following each of them." );
	} );
