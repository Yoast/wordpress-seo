...
describe( "An assessment for the topicDensity", function() {
	it( "runs the topicDensity on the paper with only keyword specified", function() {
		...
		expect( result.getText() ).toBe( "The <a href='https://yoa.st/kd1' target='_blank'>topic density</a> is 0%, which is too low; the focus keyword and its synonyms were found 0 times." );
		...
		expect( result.getText() ).toBe( "The <a href='https://yoa.st/kd1' target='_blank'>topic density</a> is 10%, which is way over the advised 3.5% maximum; the focus keyword and its synonyms were found 50 times." );
		...
		expect( result.getText() ).toBe( "The <a href='https://yoa.st/kd1' target='_blank'>topic density</a> is 2%, which is great; the focus keyword and its synonyms were found 1 time." );
		...
		expect( result.getText() ).toBe( "The <a href='https://yoa.st/kd1' target='_blank'>topic density</a> is 3.8%, which is over the advised 3.5% maximum; the focus keyword and its synonyms were found 2 times." );
		...
		expect( result.getScore() ).toBe( 9 );
		expect( result.getText() ).toBe( "The <a href='https://yoa.st/kd1' target='_blank'>topic density</a> is 0.5%, which is great; the focus keyword and its synonyms were found 2 times." );
	} );
} );
