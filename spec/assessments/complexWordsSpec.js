...
describe( "an assessment returning complex words", function() {
	...
	it( "runs a test with exactly 10% too many syllables", function(){
		...
		expect( result.getText() ).toBe( "10% of the words contain over 4 syllables, which is less than or equal to the recommended maximum of 10%." );
	} );
	...
	it( "runs a test with 0% too many syllables", function(){
		...
		expect( result.getText() ).toBe( "0% of the words contain over 4 syllables, which is less than or equal to the recommended maximum of 10%." );
	} )
