...
class MigratorUtilTestSingleDirectory extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $framework = new \YoastSEO_Vendor\Ruckusing_FrameworkRunner($ruckusing_config, array('ENV=mysql_test', 'module=default'));
        ...
        if (!\is_dir($this->migrations_dirs['default'])) {
            \mkdir($this->migrations_dirs['default'], 0755, \true);
        }
    }
    //setUp()
    /**
    ...
    public function test_get_runnable_migrations_going_up_no_target_version()
    {
        ...
        $expect_up_files = array(array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'));
    ...
    public function test_get_runnable_migrations_going_up_with_target_version_no_current()
    {
        ...
        $expect_up_files = array(array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_up_files, $actual_up_files);
    }
    /**
    ...
    public function test_get_runnable_migrations_going_up_with_target_version_with_current()
    {
        ...
        $this->insert_dummy_version_data(array(1));
        $actual_up_files = $migrator_util->get_runnable_migrations($this->migrations_dirs, 'up', 3, \false);
        $expect_up_files = array(array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_up_files, $actual_up_files);
        $this->clear_dummy_data();
    ...
    public function test_get_runnable_migrations_going_down_with_target_version_no_current()
    {
        ...
        $expect_down_files = array(array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_down_files, $actual_down_files);
        $this->clear_dummy_data();
        $this->insert_dummy_version_data(array(3));
        $actual_down_files = $migrator_util->get_runnable_migrations($this->migrations_dirs, 'down', 1, \false);
        $expect_down_files = array(array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_down_files, $actual_down_files);
        //go all the way down!
        $this->clear_dummy_data();
        ...
        $expect_down_files = array(array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'));
        $this->assertEquals($expect_down_files, $actual_down_files);
    }
}
