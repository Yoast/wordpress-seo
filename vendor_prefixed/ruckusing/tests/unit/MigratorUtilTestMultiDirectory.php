...
class MigratorUtilTestMultiDirectory extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $framework = new \YoastSEO_Vendor\Ruckusing_FrameworkRunner($ruckusing_config, array('ENV=mysql_test'));
        ...
        $this->migrations_dirs['additional'] = \YOASTSEO_VENDOR__RUCKUSING_WORKING_BASE . '/migrations/second_test_dir';
    ...
    protected function tearDown()
    {
        ...
        $this->adapter->query('DELETE FROM ' . \YOASTSEO_VENDOR__RUCKUSING_TS_SCHEMA_TBL_NAME);
    }
    /**
    ...
    private function insert_dummy_version_data($data)
    {
        foreach ($data as $version) {
            $insert_sql = \sprintf("INSERT INTO %s (version) VALUES ('%s')", \YOASTSEO_VENDOR__RUCKUSING_TS_SCHEMA_TBL_NAME, $version);
    ...
    {
        $migrator_util = new \YoastSEO_Vendor\Ruckusing_Util_Migrator($this->adapter);
        $this->clear_dummy_data();
        $this->assertEquals(\null, $migrator_util->get_max_version());
    ...
    public function test_resolve_current_version_going_up()
    {
        ...
        $this->assertEquals(\true, \in_array(3, $executed));
        $this->assertEquals(\true, \in_array(1, $executed));
    ...
    public function test_resolve_current_version_going_down()
    {
        ...
        $this->assertEquals(\true, \in_array(1, $executed));
        $this->assertEquals(\true, \in_array(2, $executed));
    }
    /**
    ...
    public function test_get_runnable_migrations_going_up_no_target_version()
    {
        ...
        $expect_up_files = array(array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'), array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'));
    ...
    public function test_get_runnable_migrations_going_up_with_target_version_no_current()
    {
        ...
        $expect_up_files = array(array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'), array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_up_files, $actual_up_files);
    }
    /**
    ...
    public function test_get_runnable_migrations_going_up_with_target_version_with_current()
    {
        ...
        $this->insert_dummy_version_data(array(1));
        $actual_up_files = $migrator_util->get_runnable_migrations($this->migrations_dirs, 'up', 3, \false);
        $expect_up_files = array(array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'));
        $this->assertEquals($expect_up_files, $actual_up_files);
        $this->clear_dummy_data();
    ...
    public function test_get_runnable_migrations_going_down_with_target_version_no_current()
    {
        ...
        $expect_down_files = array(array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'));
        $this->assertEquals($expect_down_files, $actual_down_files);
        $this->clear_dummy_data();
        $this->insert_dummy_version_data(array(2, 3));
        $actual_down_files = $migrator_util->get_runnable_migrations($this->migrations_dirs, 'down', 1, \false);
        $expect_down_files = array(array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'));
        $this->assertEquals($expect_down_files, $actual_down_files);
        //go all the way down!
        $this->clear_dummy_data();
        ...
        $expect_down_files = array(array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'), array('version' => 3, 'class' => 'AddIndexToBlogs', 'file' => '003_AddIndexToBlogs.php', 'module' => 'default'), array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'), array('version' => 1, 'class' => 'CreateUsers', 'file' => '001_CreateUsers.php', 'module' => 'default'));
        $this->assertEquals($expect_down_files, $actual_down_files);
    }
    ...
    public function test_get_runnable_migrations_going_up_with_target_version_no_current_new_module()
    {
        ...
        $expect_up_files = array(array('version' => 2, 'class' => 'JustNewMigration', 'file' => '002_JustNewMigration.php', 'module' => 'additional'), array('version' => '20090122193325', 'class' => 'AddNewTable', 'file' => '20090122193325_AddNewTable.php', 'module' => 'default'));
        $this->assertEquals($expect_up_files, $actual_up_files);
