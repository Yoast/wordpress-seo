...
class Ruckusing_FrameworkRunner
{
     ...
     */
    public function __construct($config, $argv, \YoastSEO_Vendor\Ruckusing_Util_Logger $log = \null)
    {
        ...
        $this->load_all_adapters(\YOASTSEO_VENDOR__RUCKUSING_BASE . \DIRECTORY_SEPARATOR . 'lib' . \DIRECTORY_SEPARATOR . 'Ruckusing' . \DIRECTORY_SEPARATOR . 'Adapter');
        //initialize logger
        $this->initialize_db();
        //initialize tasks
        $this->init_tasks();
    ...
    public function update_schema_for_timestamps()
    {
        ...
        foreach ($files as $file) {
            ...
            $query_sql = \sprintf("SELECT version FROM %s WHERE version >= %d", \YOASTSEO_VENDOR__RUCKUSING_SCHEMA_TBL_NAME, $file['version']);
