...
namespace {
     ...
     */
    \define('YOASTSEO_VENDOR__RUCKUSING_TASK_DIR', \YOASTSEO_VENDOR__RUCKUSING_BASE . \DIRECTORY_SEPARATOR . 'lib' . \DIRECTORY_SEPARATOR . 'Task');
}
namespace YoastSEO_Vendor {
    ...
    class Ruckusing_Task_Manager
    {
        ...
        public function __construct($adapter, $config = \null)
        {
            ...
            $this->_config = $config;
            $this->load_all_tasks(\YOASTSEO_VENDOR__RUCKUSING_TASK_DIR);
