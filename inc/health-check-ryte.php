...
class WPSEO_Health_Check_Ryte extends WPSEO_Health_Check {
	...
	protected function add_yoast_label() {
		$this->actions .= sprintf(
		/* translators: %1$s resolves to the start of the paragraph, beginning with the Yoast icon, %2$s resolves to the opening tag of the small italic text, %3$s resolves to the closing tag of the small italic text and the paragraph.  */
