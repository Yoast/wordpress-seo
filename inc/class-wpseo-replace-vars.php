...
class WPSEO_Replace_Vars {
	...
	private static function create_variable_help_table( $type ) {
		...
		foreach ( self::$help_texts[ $type ] as $variable ) {
			$table .= '
				<tr>
					<td class="yoast-variable-label">' . esc_html( $variable->get_label() ) . '</td>
					<td class="yoast-variable-name">%%' . esc_html( $variable->get_variable() ) . '%%</td>
					<td class="yoast-variable-desc">' . $variable->get_description() . '</td>
				</tr>';
		}
	...
	private static function set_basic_help_texts() {
		self::$help_texts['basic'] = array(
			new WPSEO_Replace_Var_Data( 'date', 'date', __( 'Replaced with the date of the post/page', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'title','title', __( 'Replaced with the title of the post/page', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'parent_title', 'parent_title', __( 'Replaced with the title of the parent page of the current page', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'archive_title', 'archive_title', __( 'Replaced with the normal title for an archive generated by WordPress', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'sitename', 'sitename', __( 'The site\'s name', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'excerpt', 'excerpt', __( 'Replaced with the post/page excerpt (or auto-generated if it does not exist)', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'excerpt_only', 'excerpt_only', __( 'Replaced with the post/page excerpt (without auto-generation)', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'tag', 'tag', __( 'Replaced with the current tag/tags', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'category', 'category', __( 'Replaced with the post categories (comma separated)', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'primary_category', 'primary_category', __( 'Replaced with the primary category of the post/page', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'category_description', 'category_description', __( 'Replaced with the category description', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'tag_description', 'tag_description', __( 'Replaced with the tag description', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'term_description', 'term_description', __( 'Replaced with the term description', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'term_title', 'term_title', __( 'Replaced with the term name', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'searchphrase', 'searchphrase', __( 'Replaced with the current search phrase', 'wordpress-seo' ) ),
			new WPSEO_Replace_Var_Data( 'sep', 'sep', sprintf(
