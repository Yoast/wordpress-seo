...
class WPSEO_Replace_Vars {
		...
		if ( is_string( $var ) && $var !== '' ) {
			...
			elseif ( ! method_exists( __CLASS__, 'retrieve_' . $var ) ) {
				if ( ! isset( self::$external_replacements[ $var ] ) ) {
					...
					self::register_help_text( $type, $var, $var, $help_text );
					$success = true;
				}
				else {
		...
		foreach ( self::$help_texts[ $type ] as $variable => $variable_data ) {
			$table .= '
				<tr>
					...
					<td class="yoast-variable-name">%%' . esc_html( $variable ) . '%%</td>
	 ...
	 */
	private static function register_help_text( $type, $replace, $label, $help_text = '' ) {
		if ( is_string( $replace ) && $replace !== '' ) {
			...
			if ( ( is_string( $type ) && in_array( $type, array(
				...
				self::$help_texts[ $type ][ $replace ] = new WPSEO_Replace_Var_Data( $label, $help_text );
			}
		}
	}
	...
	private static function set_basic_help_texts() {
		self::$help_texts['basic'] = array(
			'date'                  => new WPSEO_Replace_Var_Data( __( 'Date',  'wordpress-seo' ), __( 'Replaced with the date of the post/page', 'wordpress-seo' ) ),
			'title'                 => new WPSEO_Replace_Var_Data( __( 'Title',  'wordpress-seo' ), __( 'Replaced with the title of the post/page', 'wordpress-seo' ) ),
			'parent_title'          => new WPSEO_Replace_Var_Data( __( 'Parent title',  'wordpress-seo' ), __( 'Replaced with the title of the parent page of the current page', 'wordpress-seo' ) ),
			'archive_title'         => new WPSEO_Replace_Var_Data( 'archive_title', __( 'Replaced with the normal title for an archive generated by WordPress', 'wordpress-seo' ) ),
			'sitename'              => new WPSEO_Replace_Var_Data( __( 'Site title',  'wordpress-seo' ), __( 'The site\'s name', 'wordpress-seo' ) ),
			'excerpt'               => new WPSEO_Replace_Var_Data( __( 'Excerpt',  'wordpress-seo' ), __( 'Replaced with the post/page excerpt (or auto-generated if it does not exist)', 'wordpress-seo' ) ),
			'excerpt_only'          => new WPSEO_Replace_Var_Data( __( 'Excerpt only',  'wordpress-seo' ), __( 'Replaced with the post/page excerpt (without auto-generation)', 'wordpress-seo' ) ),
			'tag'                   => new WPSEO_Replace_Var_Data( 'tag', __( 'Replaced with the current tag/tags', 'wordpress-seo' ) ),
			'category'              => new WPSEO_Replace_Var_Data( __( 'Category',  'wordpress-seo' ), __( 'Replaced with the post categories (comma separated)', 'wordpress-seo' ) ),
			'primary_category'      => new WPSEO_Replace_Var_Data( __( 'Primary category',  'wordpress-seo' ), __( 'Replaced with the primary category of the post/page', 'wordpress-seo' ) ),
			'category_description'  => new WPSEO_Replace_Var_Data( __( 'Category description',  'wordpress-seo' ), __( 'Replaced with the category description', 'wordpress-seo' ) ),
			'tag_description'       => new WPSEO_Replace_Var_Data( __( 'Tag description',  'wordpress-seo' ), __( 'Replaced with the tag description', 'wordpress-seo' ) ),
			'term_description'      => new WPSEO_Replace_Var_Data( __( 'Term description',  'wordpress-seo' ), __( 'Replaced with the term description', 'wordpress-seo' ) ),
			'term_title'            => new WPSEO_Replace_Var_Data( 'term_title', __( 'Replaced with the term name', 'wordpress-seo' ) ),
			'searchphrase'          => new WPSEO_Replace_Var_Data( __( 'Search phrase',  'wordpress-seo' ), __( 'Replaced with the current search phrase', 'wordpress-seo' ) ),
			'sep'                   => new WPSEO_Replace_Var_Data( __( 'Separator',  'wordpress-seo' ), sprintf(
	...
	private static function set_advanced_help_texts() {
		self::$help_texts['advanced'] = array(
			...
			'id'                        => new WPSEO_Replace_Var_Data( __( 'ID',  'wordpress-seo' ), __( 'Replaced with the post/page ID', 'wordpress-seo' ) ),
			...
			'page'                      => new WPSEO_Replace_Var_Data( __( 'Page number',  'wordpress-seo' ), __( 'Replaced with the current page number with context (i.e. page 2 of 4)', 'wordpress-seo' ) ),
			...
			'focuskw'                   => new WPSEO_Replace_Var_Data( __( 'Focus keyword',  'wordpress-seo' ), __( 'Replaced with the posts focus keyword', 'wordpress-seo' ) ),
