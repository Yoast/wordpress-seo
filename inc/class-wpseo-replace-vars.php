...
class WPSEO_Replace_Vars {
	...
	private static function set_advanced_help_texts() {
		$replacement_variables = array(
			...
			new WPSEO_Replacement_Variable( 'cf_<custom-field-name>', __( '<custom-field-name> (custom field)', 'wordpress-seo' ) , __( 'Replaced with a posts custom field value', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'ct_<custom-tax-name>', __( '<custom-tax-name> (custom taxonomy)', 'wordpress-seo' ), __( 'Replaced with a posts custom taxonomies, comma separated.', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'ct_desc_<custom-tax-name>', __( '<custom-tax-name> description (custom taxonomy)', 'wordpress-seo' ), __( 'Replaced with a custom taxonomies description', 'wordpress-seo' ) ),
		);
