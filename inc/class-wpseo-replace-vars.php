...
class WPSEO_Replace_Vars {
	...
	/**
	 * @var array List of example texts for use in WPSEO -> Search appearance tabs.
	 */
	protected static $example_texts = array();
	...
	public static function get_example_settings_texts() {
		return array(
			...
			'sitename' => get_bloginfo( 'name', 'wordpress-seo' ),
			'sitedesc' => get_bloginfo( 'description', 'wordpress-seo' ),
			'excerpt' => __( 'Example post/page excerpt and autogenerated content if it exists', 'wordpress-seo' ),
			'excerpt_only' => __( 'Example post/page excerpt', 'wordpress-seo' ),
			'tag' => __( 'Example tags', 'wordpress-seo' ),
			'category' => __( 'Example categories', 'wordpress-seo' ),
			'primary_category' => __( 'Example primary category', 'wordpress-seo' ),
