...
class WPSEO_Replace_Vars {
	...
	private static function set_basic_help_texts() {
		self::$help_texts['basic'] = array(
			'date'                  => new WPSEO_Replace_Var_Data('date', __( 'Replaced with the date of the post/page', 'wordpress-seo' ) ),
			'title'                 => new WPSEO_Replace_Var_Data('title', __( 'Replaced with the title of the post/page', 'wordpress-seo' ) ),
			'parent_title'          => new WPSEO_Replace_Var_Data('parent_title', __( 'Replaced with the title of the parent page of the current page', 'wordpress-seo' ) ),
			...
			'sitename'              => new WPSEO_Replace_Var_Data('sitename', __( 'The site\'s name', 'wordpress-seo' ) ),
			'excerpt'               => new WPSEO_Replace_Var_Data('excerpt', __( 'Replaced with the post/page excerpt (or auto-generated if it does not exist)', 'wordpress-seo' ) ),
			'excerpt_only'          => new WPSEO_Replace_Var_Data('excerpt_only', __( 'Replaced with the post/page excerpt (without auto-generation)', 'wordpress-seo' ) ),
			'tag'                   => new WPSEO_Replace_Var_Data('tag', __( 'Replaced with the current tag/tags', 'wordpress-seo' ) ),
			'category'              => new WPSEO_Replace_Var_Data('category', __( 'Replaced with the post categories (comma separated)', 'wordpress-seo' ) ),
			'primary_category'      => new WPSEO_Replace_Var_Data('primary_category', __( 'Replaced with the primary category of the post/page', 'wordpress-seo' ) ),
			'category_description'  => new WPSEO_Replace_Var_Data( 'category_description', __( 'Replaced with the category description', 'wordpress-seo' ) ),
			'tag_description'       => new WPSEO_Replace_Var_Data( 'tag_description', __( 'Replaced with the tag description', 'wordpress-seo' ) ),
			'term_description'      => new WPSEO_Replace_Var_Data('term_description', __( 'Replaced with the term description', 'wordpress-seo' ) ),
			'term_title'            => new WPSEO_Replace_Var_Data('term_title', __( 'Replaced with the term name', 'wordpress-seo' ) ),
			'searchphrase'          => new WPSEO_Replace_Var_Data('searchphrase', __( 'Replaced with the current search phrase', 'wordpress-seo' ) ),
			'sep'                   => new WPSEO_Replace_Var_Data('sep', sprintf(
