...
class WPSEO_Replace_Vars {
	...
	private static function set_basic_help_texts() {
		$replacement_variables = array(
			...
			new WPSEO_Replacement_Variable( 'archive_title', 'archive_title', __( 'Replaced with the normal title for an archive generated by WordPress', 'wordpress-seo' ) ),
			...
			new WPSEO_Replacement_Variable( 'tag', 'tag', __( 'Replaced with the current tag/tags', 'wordpress-seo' ) ),
			...
			new WPSEO_Replacement_Variable( 'term_title', 'term_title', __( 'Replaced with the term name', 'wordpress-seo' ) ),
	...
	private static function set_advanced_help_texts() {
		$replacement_variables = array(
			new WPSEO_Replacement_Variable( 'pt_single', 'pt_single', __( 'Replaced with the content type single label', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'pt_plural', 'pt_plural', __( 'Replaced with the content type plural label', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'modified', 'modified', __( 'Replaced with the post/page modified time', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'id', __( 'ID',  'wordpress-seo' ), __( 'Replaced with the post/page ID', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'name', 'name', __( 'Replaced with the post/page author\'s \'nicename\'', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'user_description', 'user_description', __( 'Replaced with the post/page author\'s \'Biographical Info\'', 'wordpress-seo' ) ),
			...
			new WPSEO_Replacement_Variable( 'pagetotal', 'pagetotal', __( 'Replaced with the current page total', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'pagenumber', 'pagenumber', __( 'Replaced with the current page number', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'caption', 'caption', __( 'Attachment caption', 'wordpress-seo' ) ),
			...
			new WPSEO_Replacement_Variable( 'term404', 'term404', __( 'Replaced with the slug which caused the 404', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'cf_<custom-field-name>', 'cf_<custom-field-name>', __( 'Replaced with a posts custom field value', 'wordpress-seo' ) ),
			new WPSEO_Replacement_Variable( 'ct_<custom-tax-name>', 'ct_<custom-tax-name>', __( 'Replaced with a posts custom taxonomies, comma separated.', 'wordpress-seo' ) ),
