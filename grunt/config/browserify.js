module.exports = {
	build: {
		files: {
			'js/dist/wp-seo-admin-global-330.js': ['js/src/wp-seo-admin-global.js'],
			...
			'js/dist/wp-seo-post-scraper-331.js': ['js/src/wp-seo-post-scraper.js'],
			...
			'js/dist/wp-seo-term-scraper-331.js': ['js/src/wp-seo-term-scraper.js']
		}
	},
	buildes6: {
		options: {
