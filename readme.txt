...
* Improves the results for prominent words shown in Insights by excluding URLs and email addresses.
...
* Fixes a bug where the highlighting feature in Classic editor was not working when inline HTML tags were present.
