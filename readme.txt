 ...
 * Ensures the indexing spots the indexables without a permalink.
 ...
 * Fixes a bug where the indexable indexing process could not be started again without a page reload on the tools page if it failed.
